CREATE   PROC [collection].[Create_dm_EnforcementOrders_Ext]
AS
BEGIN
	set nocount on
	SET XACT_ABORT on
begin try
	...
	--INTO collection.dm_EnforcementOrders_Ext
	...
	TRUNCATE TABLE collection.dm_EnforcementOrders_Ext

	INSERT collection.dm_EnforcementOrders_Ext
	(
		[№ договора],
		[Фамилия],
		[Имя],
