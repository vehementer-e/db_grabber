...
CREATE PROC dbo.Create_dm_FedorVerificationRequests
	...
	*/
	...
	select 
		...
		IncomeVerificationSource = 
			string_agg(a.IncomeVerificationSource, '; ')
			WITHIN GROUP (ORDER BY a.IncomeVerificationSource)
	...
	begin
		...
		if @count_change_request <= 5000 begin
			begin tran
				DELETE D
				...
				insert dbo.dm_FedorVerificationRequests
				select r.* 
