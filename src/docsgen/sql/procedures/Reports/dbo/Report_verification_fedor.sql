--select  newid()
/*
exec Reports.dbo.Report_verification_fedor @Page = 'KD.Daily.Common' , @ProcessGUID = '3567EEDA-9021-4BFE-93C9-C1E512F338EC', @isDebug = 1
exec Reports.dbo.Report_verification_fedor 'TS.Daily.PostponeUnique'
exec Reports.dbo.Report_verification_fedor 'KD.Monthly.PostponeUnique'
exec Reports.dbo.Report_verification_fedor 'KD.Daily.PostponeUnique'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.PostponeUnique'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.PostponeUnique'

--exec Reports.dbo.Report_verification_fedor 'ReportByEmployee'
exec Reports.dbo.Report_verification_fedor 'ReportByEmployeeAgg'
exec Reports.dbo.Report_verification_fedor 'ReportByEmployeeAgg_LastHour'

--exec Reports.dbo.Report_verification_fedor 'ReportByEmployee_VK'
exec Reports.dbo.Report_verification_fedor 'ReportByEmployeeAgg_VK'
exec Reports.dbo.Report_verification_fedor 'ReportByEmployeeAgg_VK_LastHour'

exec Reports.dbo.Report_verification_fedor 'ReportByEmployee_TS'
exec Reports.dbo.Report_verification_fedor 'ReportByEmployeeAgg_TS'
exec Reports.dbo.Report_verification_fedor 'ReportByEmployeeAgg_TS_LastHour'

exec Reports.dbo.Report_verification_fedor 'Detail'
exec Reports.dbo.Report_verification_fedor 'Contact.Detail'
exec Reports.dbo.Report_verification_fedor 'Contact.DetailByEmployee'
exec Reports.dbo.Report_verification_fedor 'KD.Detail'
exec Reports.dbo.Report_verification_fedor 'VK.Detail'
exec Reports.dbo.Report_verification_fedor 'VTC.Detail'
exec Reports.dbo.Report_verification_fedor 'PD.Detail'
exec Reports.dbo.Report_verification_fedor 'PSV.Detail'

exec Reports.dbo.Report_verification_fedor 'KD.Daily.Total'
exec Reports.dbo.Report_verification_fedor 'KD.Daily.Unic'
exec Reports.dbo.Report_verification_fedor 'KD.Daily.AvgTime'
exec Reports.dbo.Report_verification_fedor 'KD.Daily.Approved'
exec Reports.dbo.Report_verification_fedor 'KD.Daily.Postpone'
exec Reports.dbo.Report_verification_fedor 'KD.Daily.Rework'
exec Reports.dbo.Report_verification_fedor 'KD.Daily.AR'

exec Reports.dbo.Report_verification_fedor 'VK.Daily.Total'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.Unic'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.AvgTime'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.Approved' 
exec Reports.dbo.Report_verification_fedor 'VK.Daily.Postpone'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.Rework'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.AR'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.Contact'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.Contact.Approved'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.Contact.Denied'

exec Reports.dbo.Report_verification_fedor 'TS.Daily.Total'
exec Reports.dbo.Report_verification_fedor 'TS.Daily.Unic'
exec Reports.dbo.Report_verification_fedor 'TS.Daily.AvgTime'
exec Reports.dbo.Report_verification_fedor 'TS.Daily.Approved' 
exec Reports.dbo.Report_verification_fedor 'TS.Daily.Postpone'
exec Reports.dbo.Report_verification_fedor 'TS.Daily.Rework'
exec Reports.dbo.Report_verification_fedor 'TS.Daily.AR'

exec Reports.dbo.Report_verification_fedor 'KD.Monthly.Total'
exec Reports.dbo.Report_verification_fedor 'KD.Monthly.Unic'
exec Reports.dbo.Report_verification_fedor 'KD.Monthly.AvgTime'
exec Reports.dbo.Report_verification_fedor 'KD.Monthly.Approved'
exec Reports.dbo.Report_verification_fedor 'KD.Monthly.Postpone'
exec Reports.dbo.Report_verification_fedor 'KD.Monthly.Rework'
exec Reports.dbo.Report_verification_fedor 'KD.Monthly.AR'

exec Reports.dbo.Report_verification_fedor 'VK.Monthly.Total'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.Unic'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.AvgTime'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.Approved'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.AR'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.Contact'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.Contact.Approved'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.Contact.Denied'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.Postpone'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.Rework'



exec Reports.dbo.Report_verification_fedor 'TS.Monthly.Total'
exec Reports.dbo.Report_verification_fedor 'TS.Monthly.Unic'
exec Reports.dbo.Report_verification_fedor 'TS.Monthly.AvgTime'
exec Reports.dbo.Report_verification_fedor 'TS.Monthly.Approved' 
exec Reports.dbo.Report_verification_fedor 'TS.Monthly.AR'
exec Reports.dbo.Report_verification_fedor 'TS.Monthly.Postpone'
exec Reports.dbo.Report_verification_fedor 'TS.Monthly.PostponeUnique'
exec Reports.dbo.Report_verification_fedor 'TS.Monthly.Rework'


exec Reports.dbo.Report_verification_fedor 'KD.Daily.Common'
exec Reports.dbo.Report_verification_fedor 'V.Daily.Common' 

exec Reports.dbo.Report_verification_fedor 'KD.Monthly.Common', '2021-03-01', '2021-03-29'
exec Reports.dbo.Report_verification_fedor 'V.Monthly.Common'


exec Reports.dbo.Report_verification_fedor 'KD.Daily.Common', '2021-03-28', '2021-03-29'
exec Reports.dbo.Report_verification_fedor 'KD.Daily.Total'

exec Reports.dbo.Report_verification_fedor 'KD.Daily.Approved'

exec Reports.dbo.Report_verification_fedor 'DetailHours'
exec Reports.dbo.Report_verification_fedor 'KD.DetailHours'
exec Reports.dbo.Report_verification_fedor 'VK.DetailHours'
exec Reports.dbo.Report_verification_fedor 'VTC.DetailHours'

exec Reports.dbo.Report_verification_fedor 'KD.HoursGroupMonth'
exec Reports.dbo.Report_verification_fedor 'KD.HoursGroupMonthUnique'
exec Reports.dbo.Report_verification_fedor 'KD.HoursGroupDays'
exec Reports.dbo.Report_verification_fedor 'KD.HoursGroupDaysUnique'

exec Reports.dbo.Report_verification_fedor 'VK.HoursGroupMonth'
exec Reports.dbo.Report_verification_fedor 'VK.HoursGroupMonthUnique'
exec Reports.dbo.Report_verification_fedor 'VK.HoursGroupDays'
exec Reports.dbo.Report_verification_fedor 'VK.HoursGroupDaysUnique'

exec Reports.dbo.Report_verification_fedor 'TS.HoursGroupMonth'
exec Reports.dbo.Report_verification_fedor 'TS.HoursGroupMonthUnique'
exec Reports.dbo.Report_verification_fedor 'TS.HoursGroupDays'

exec Reports.dbo.Report_verification_fedor 'PD.Daily.Total'
exec Reports.dbo.Report_verification_fedor 'PD.Daily.Unic'
exec Reports.dbo.Report_verification_fedor 'PD.Daily.AvgTime'
exec Reports.dbo.Report_verification_fedor 'PD.Daily.Approved'
exec Reports.dbo.Report_verification_fedor 'PD.Daily.Postpone'
exec Reports.dbo.Report_verification_fedor 'PD.Daily.PostponeUnique'
exec Reports.dbo.Report_verification_fedor 'PD.Daily.Rework'
exec Reports.dbo.Report_verification_fedor 'PD.Daily.AR'

exec Reports.dbo.Report_verification_fedor 'PSV.Daily.Total'
exec Reports.dbo.Report_verification_fedor 'PSV.Daily.Unic'
exec Reports.dbo.Report_verification_fedor 'PSV.Daily.AvgTime'
exec Reports.dbo.Report_verification_fedor 'PSV.Daily.Approved'
exec Reports.dbo.Report_verification_fedor 'PSV.Daily.Postpone'
exec Reports.dbo.Report_verification_fedor 'PSV.Daily.PostponeUnique'
exec Reports.dbo.Report_verification_fedor 'PSV.Daily.Rework'
exec Reports.dbo.Report_verification_fedor 'PSV.Daily.AR'


exec Reports.dbo.Report_verification_fedor 'KD.Monthly.ALL'
exec Reports.dbo.Report_verification_fedor 'PD.Monthly.ALL'
exec Reports.dbo.Report_verification_fedor 'VK.Monthly.ALL'
exec Reports.dbo.Report_verification_fedor 'TS.Monthly.ALL'
exec Reports.dbo.Report_verification_fedor 'PSV.Monthly.ALL'

exec Reports.dbo.Report_verification_fedor 'KD.Daily.ALL'
exec Reports.dbo.Report_verification_fedor 'PD.Daily.ALL'
exec Reports.dbo.Report_verification_fedor 'VK.Daily.ALL'
exec Reports.dbo.Report_verification_fedor 'TS.Daily.ALL'
exec Reports.dbo.Report_verification_fedor 'PSV.Daily.ALL'


exec Reports.dbo.Report_verification_fedor 'Clear_All_Tables'


*/

CREATE PROC dbo.Report_verification_fedor
--declare
  ...
  ,@ProductTypeCode varchar(30) = 'pts'
  ,@isDebug int = 0
AS
BEGIN
...
BEGIN TRY
	...
	SELECT @ProductTypeCode = isnull(@ProductTypeCode, 'pts')
	...
	BEGIN
		IF EXISTS(
			SELECT TOP 1 1
			FROM LogDb.dbo.Fill_Report_verification_fedor AS F
		...
		ELSE BEGIN
			BEGIN TRY
				...
				INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
	...
	BEGIN
		...
		BEGIN
		    ...
		    EXEC dbo.Report_verification_fedor
	...
	EXEC LogDb.dbo.LogAndSendMailToAdmin 
		@eventName = 'Report_verification_fedor',
...
ELSE BEGIN
	...
	IF @Page = 'KD.Monthly.Common' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_Common AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	
	IF @Page = 'KD.Daily.Common' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_Common AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'V.Monthly.Common' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_V_Monthly_Common AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'Detail' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_Detail AS T
		WHERE T.ProcessGUID = @ProcessGUID
	...
	IF @Page = 'Contact.Detail' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_Contact_Detail AS T
		WHERE T.ProcessGUID = @ProcessGUID
		ORDER BY T.[ФИО сотрудника верификации/чекер], T.[Дата статуса] desc, T.[Номер заявки] desc
	END
	...
	IF @Page = 'Contact.DetailByEmployee' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_Contact_DetailByEmployee AS T
		WHERE T.ProcessGUID = @ProcessGUID
	...
	IF @Page = 'KD.Monthly.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Monthly.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Monthly.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Monthly.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Monthly.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Monthly.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Daily.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Daily.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Daily.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Daily.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Daily.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Daily.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'KD.Detail' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Detail AS T
		WHERE T.ProcessGUID = @ProcessGUID
	...
	IF @Page = 'VK.Detail' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Detail AS T
		WHERE T.ProcessGUID = @ProcessGUID
		--ORDER BY T.[ФИО сотрудника верификации/чекер], T.[Дата статуса] DESC, T.[Номер заявки] DESC
	...
	IF @Page = 'KD.Daily.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Daily.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.Monthly.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'DetailHours' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_DetailHours AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'KD.DetailHours' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_DetailHours AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.DetailHours' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_DetailHours AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VTC.DetailHours' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VTC_DetailHours AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	...
	IF @Page = 'VK.Monthly.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.Contact' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_Contact AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.Contact.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_Contact_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.Contact.Denied' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_Contact_Denied AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.Contact' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_Contact AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.Contact.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_Contact_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.Contact.Denied' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_Contact_Denied AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Daily.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.Monthly.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.HoursGroupMonth' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_HoursGroupMonth AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.HoursGroupMonthUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_HoursGroupMonthUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.HoursGroupDaysUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_HoursGroupDaysUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VK.HoursGroupDays' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_HoursGroupDays AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	...
	IF @Page = 'V.Daily.Common' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_V_Daily_Common AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Monthly.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Monthly_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Monthly.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Monthly_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Monthly.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Monthly_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Monthly.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Monthly_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Monthly.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Monthly_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Monthly.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Monthly_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Daily.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Daily_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Daily.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Daily_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Daily.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Daily_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Daily.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Daily_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Daily.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Daily_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Daily.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Daily_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'VTC.Detail' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VTC_Detail AS T
		WHERE T.ProcessGUID = @ProcessGUID
		ORDER BY T.[Номер заявки] DESC, T.[Дата статуса] DESC
	END
	IF @Page = 'KD.Monthly.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Monthly.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Monthly_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Daily.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Daily_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'ReportByEmployee' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_ReportByEmployee AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Daily.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Daily_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.Monthly.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Monthly_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.HoursGroupDays' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_HoursGroupDays AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.HoursGroupMonth' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_HoursGroupMonth AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.HoursGroupDaysUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_HoursGroupDaysUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'KD.HoursGroupMonthUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_HoursGroupMonthUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.HoursGroupMonthUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_HoursGroupMonthUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.HoursGroupMonth' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_HoursGroupMonth AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.HoursGroupDaysUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_HoursGroupDaysUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	IF @Page = 'TS.HoursGroupDays' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_HoursGroupDays AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END



	IF @Page = 'PD.Daily.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Daily.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Daily.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Daily.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Daily.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Daily.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Daily.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Daily.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END


	IF @Page = 'PD.HoursGroupDaysUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_HoursGroupDaysUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.HoursGroupDays' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_HoursGroupDays AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.HoursGroupMonthUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_HoursGroupMonthUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.HoursGroupMonth' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_HoursGroupMonth AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Daily.Common' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_Common AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.Common' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_Common AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Detail' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Detail AS T
		WHERE T.ProcessGUID = @ProcessGUID
		ORDER BY T.[ФИО сотрудника верификации/чекер] asc, T.[Дата заведения заявки] desc, T.[Время заведения] desc
	END
	...
	IF @Page = 'PSV.Daily.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.Total' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_Total AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Daily.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.Unic' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_Unic AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Daily.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.AvgTime' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_AvgTime AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Daily.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.Approved' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_Approved AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Daily.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Daily.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.Postpone' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_Postpone AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.PostponeUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_PostponeUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Daily.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.Rework' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_Rework AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Daily.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.AR' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_AR AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END


	IF @Page = 'PSV.HoursGroupDaysUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_HoursGroupDaysUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.HoursGroupDays' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_HoursGroupDays AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.HoursGroupMonthUnique' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonthUnique AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.HoursGroupMonth' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonth AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Daily.Common' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_Common AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.Common' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_Common AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Detail' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Detail AS T
		WHERE T.ProcessGUID = @ProcessGUID
		ORDER BY T.[ФИО сотрудника верификации/чекер] asc, T.[Дата заведения заявки] desc, T.[Время заведения] desc
	END
	...
	IF @Page = 'KD.Monthly.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Monthly_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Monthly.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Monthly_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'VK.Monthly.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Monthly_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'TS.Monthly.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Monthly_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Monthly.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
	...
	IF @Page = 'KD.Daily.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_KD_Daily_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PD.Daily.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PD_Daily_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'VK.Daily.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_VK_Daily_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'TS.Daily.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_TS_Daily_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END

	IF @Page = 'PSV.Daily.ALL' BEGIN
		SELECT T.*
		FROM tmp.TMP_Report_verification_fedor_PSV_Daily_ALL AS T
		WHERE T.ProcessGUID = @ProcessGUID
	END
...
END
  ...
  if @dtTo is not null
	...
	FROM Reports.dbo.dm_FedorVerificationRequests AS R
	...
	drop table if exists #t_dm_FedorVerificationRequests
	CREATE TABLE #t_dm_FedorVerificationRequests
	(
		...
		[Дата рассмотрения заявки] datetime2 NULL,
		Партнер varchar(50) NULL,
		--ПроверкаДохода int NULL,
		ПроверкаДохода varchar(255),
		[Тип документа подтверждающего доход] varchar(500),
		КодТипКредитногоПродукта varchar(30),
		КодПодТипКредитногоПродукта varchar(30)
	)

	INSERT #t_dm_FedorVerificationRequests
	(
		IdClientRequest,
	...
	WHERE 1=1
		AND R.[Дата статуса] >= @dt_from
		AND R.[Дата статуса] < @dt_to
		and isnull(R.КодТипКредитногоПродукта, 'pts') = @ProductTypeCode
	...
	*/
	...
	FROM #t_dm_FedorVerificationRequests AS T

	IF @isDebug = 1 BEGIN
		DROP TABLE IF EXISTS ##t_dm_FedorVerificationRequests
		SELECT * INTO ##t_dm_FedorVerificationRequests FROM #t_dm_FedorVerificationRequests
	END
...
DELETE R
FROM #t_dm_FedorVerificationRequests AS R
WHERE 1=1
...
WHERE 1=1
	...
	ON #t_dm_FedorVerificationRequests([Номер заявки], [Дата статуса])

	CREATE INDEX ix2
	ON #t_dm_FedorVerificationRequests([Статус], [Дата статуса])
	include([Номер заявки], IdClientRequest, [Статус следующий])

	CREATE INDEX ix3
	ON #t_dm_FedorVerificationRequests(Работник)
	
	CREATE INDEX ix4
	ON #t_dm_FedorVerificationRequests([Дата заведения заявки], [Номер заявки])
...
-- статические справочники
  --select  distinct [ФИО сотрудника верификации/чекер] from #t_dm_FedorVerificationRequests
...
WHERE R.[Статус] in ('Контроль данных' ,'Верификация клиента' ,'Верификация ТС', 
	'Подтверждение дохода', 'Проверка способа выдачи')
	--AND R.[Дата статуса] >= @dt_from
	--AND R.[Дата статуса] < @dt_to
...
FROM #t_request_number AS N
	INNER JOIN #t_dm_FedorVerificationRequests AS R
...
WHERE 1=1
	...
	AND (
		...
		OR (R.Статус IN ('Верификация ТС','Верификация Call 4','Верификация Call 5') AND R.[Статус следующий] IN ('Одобрено'))
		OR (R.Статус IN ('Верификация Call 3') AND R.[Статус следующий] IN ('Одобрен клиент'))
		OR (R.Статус IN ('Подтверждение дохода') AND R.[Статус следующий] IN ('Верификация Call 2.2'))
...
WHERE 1=1
	...
	--AND R.[Дата статуса] < @dt_to
	AND R.Статус IN (
		'Верификация Call 1.5','Верификация ТС','Верификация Call 3','Верификация Call 4','Верификация Call 5',
		'Подтверждение дохода', 'Проверка способа выдачи')
...
WHERE 1=1
	...
	--AND R.[Дата статуса] < @dt_to
	AND R.Статус IN (
		'Контроль данных','Верификация клиента','Верификация ТС','Верификация Call 3',
		'Верификация Call 4','Верификация Call 5',
		'Подтверждение дохода', 'Проверка способа выдачи') 
...
BEGIN
	...
	BEGIN
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_Detail
		DELETE T FROM tmp.TMP_Report_verification_fedor_Detail AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_Detail
		SELECT
			ProcessGUID = @ProcessGUID,
			R.[Дата заведения заявки]
			 , R.[Время заведения]
		   ...
		   , R.[Время, час:мин:сек]
			...
			R.Партнер
		--INTO tmp.TMP_Report_verification_fedor_Detail
		FROM #t_request_number AS N
			INNER JOIN #t_dm_FedorVerificationRequests AS R
				ON R.[Номер заявки] = N.[Номер заявки]
			--одобрено
...
BEGIN
	...
	BEGIN
		...
		/*
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_DetailHours
		DELETE T FROM tmp.TMP_Report_verification_fedor_DetailHours AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_DetailHours
		select --top 100
			ProcessGUID = @ProcessGUID,
		...
		--INTO tmp.TMP_Report_verification_fedor_DetailHours
		from #t_dm_FedorVerificationRequests fv--#details
...
IF @Page = 'KD.Detail' OR @isFill_All_Tables = 1 --241
  BEGIN
	...
	IF @isFill_All_Tables = 1
	BEGIN
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_KD_Detail
		DELETE T FROM tmp.TMP_Report_verification_fedor_KD_Detail AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_KD_Detail(
			ProcessGUID
			, [Дата заведения заявки]
			, [Время заведения]
			, [Номер заявки]
			...
			, [Дата рассмотрения заявки]
			, Партнер
			, [Наличие документа подтверждающего доход]
			, [Тип документа подтверждающего доход]
			, ПроверкаДохода
		)
		SELECT 
			...
			R.[Дата рассмотрения заявки],
			R.Партнер,
			--[Наличие документа подтверждающего доход] = case when R.ПроверкаДохода = 1 then 'Да' else 'Нет' end,
			[Наличие документа подтверждающего доход] = 
				case 
					when R.[Тип документа подтверждающего доход] is not null then 'Да' 
					else 'Нет' 
				end,
			R.[Тип документа подтверждающего доход],
			R.ПроверкаДохода
		--INTO tmp.TMP_Report_verification_fedor_KD_Detail
		FROM #t_request_number AS N
			INNER JOIN #t_dm_FedorVerificationRequests AS R
				ON R.[Номер заявки] = N.[Номер заявки]
			--одобрено
...
-- Лист "ПД. Детализация"
IF @Page = 'PD.Detail' OR @isFill_All_Tables = 1 --241
BEGIN
	DELETE #t_request_number
	DELETE #t_approved
	DELETE #t_denied
	...
	SELECT DISTINCT R.IdClientRequest, R.[Номер заявки]
	FROM #t_dm_FedorVerificationRequests AS R
	WHERE R.[Статус] in ('Подтверждение дохода')
		--AND R.[Дата статуса] >= @dt_from
		--AND R.[Дата статуса] < @dt_to
	...
	*/
	...
	WHERE 1=1
		--AND R.[Дата статуса] >= @dt_from
		--AND R.[Дата статуса] < @dt_to
		and R.[Статус] in ('Подтверждение дохода')
		AND R.[Статус следующий] IN ('Верификация Call 2.2')
	GROUP BY R.[Номер заявки]
	...
	*/
	...
	IF @isFill_All_Tables = 1
	BEGIN
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PD_Detail
		DELETE T FROM tmp.TMP_Report_verification_fedor_PD_Detail AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_PD_Detail(
			ProcessGUID
			, [Дата заведения заявки]
			, [Время заведения]
			, [Номер заявки]
		...
		SELECT 
		   ...
		   , R.[Время, час:мин:сек]
			...
			R.[Тип документа подтверждающего доход],
			R.ПроверкаДохода
		--INTO tmp.TMP_Report_verification_fedor_PD_Detail
		FROM #t_request_number AS N
			INNER JOIN #t_dm_FedorVerificationRequests AS R
				ON R.[Номер заявки] = N.[Номер заявки]
			--одобрено
		...
		INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
		SELECT getdate(), 'PD.Detail', @ProcessGUID
	END
	ELSE BEGIN
		SELECT R.[Дата заведения заявки]
			 , R.[Время заведения]
...
BEGIN
	...
	*/
	...
	IF @isFill_All_Tables = 1
	BEGIN
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PSV_Detail
		DELETE T FROM tmp.TMP_Report_verification_fedor_PSV_Detail AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_PSV_Detail
		SELECT 
			ProcessGUID = @ProcessGUID,
			R.[Дата заведения заявки]
			 , R.[Время заведения]
		   ...
		   , R.[Время, час:мин:сек]
			...
			R.[Дата рассмотрения заявки],
			R.Партнер
		--INTO tmp.TMP_Report_verification_fedor_PSV_Detail
		FROM #t_request_number AS N
			INNER JOIN #t_dm_FedorVerificationRequests AS R
				ON R.[Номер заявки] = N.[Номер заявки]
			--одобрено
...
BEGIN
	...
	BEGIN
		--Датасет не используется
		/*
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_KD_DetailHours
		DELETE T FROM tmp.TMP_Report_verification_fedor_KD_DetailHours AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_KD_DetailHours
		SELECT 
				ProcessGUID = @ProcessGUID,
				fv.[Дата заведения заявки]
				, fv.[Время заведения]
			...
			, fv.[Время, час:мин:сек]
				...
				, ШагЧасаСтатуса = row_number() over(partition by fv.[Номер заявки], fv.ШагЗаявки order by endInterval )
				, КоличествоЗаявокВЧасе = count(fv.[Номер заявки]) over(partition by hourInterval)
		--INTO tmp.TMP_Report_verification_fedor_KD_DetailHours
		from #t_dm_FedorVerificationRequests fv--#details
		cross apply dwh2.[dbo].[times_from_interval_hours] ([Дата статуса], [Дата след.статуса],60) hr 
...
FROM #t_request_number AS N
	INNER JOIN #t_dm_FedorVerificationRequests AS R
		ON R.[Номер заявки] = N.[Номер заявки]
	LEFT JOIN #t_dm_FedorVerificationRequests AS V
...
IF @Page = 'VK.Detail' OR @isFill_All_Tables = 1 --301
  BEGIN
	IF @isFill_All_Tables = 1
	BEGIN
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_VK_Detail
		DELETE T FROM tmp.TMP_Report_verification_fedor_VK_Detail AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_VK_Detail
		SELECT 
			ProcessGUID = @ProcessGUID,
			R.[Дата заведения заявки]
			 , R.[Время заведения]
		   ...
		   , R.[Время, час:мин:сек]
			...
			END,
			R.Партнер
		--INTO tmp.TMP_Report_verification_fedor_VK_Detail
		FROM #t_request_number AS N
			INNER JOIN #t_dm_FedorVerificationRequests AS R
				ON R.[Номер заявки] = N.[Номер заявки]
			--одобрено
...
BEGIN
	IF @isFill_All_Tables = 1
	BEGIN
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_Contact_Detail
		DELETE T FROM tmp.TMP_Report_verification_fedor_Contact_Detail AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_Contact_Detail
		(
		    ProcessGUID,
		    [Дата заведения заявки],
		    [Время заведения],
		...
		FROM (
			SELECT
			   ...
			   , R.[Время, час:мин:сек]
				...
				R.[Дата рассмотрения заявки]
			--INTO tmp.TMP_Report_verification_fedor_Contact_Detail
			FROM #t_request_number AS N
				INNER JOIN #t_dm_FedorVerificationRequests AS R
					ON R.[Номер заявки] = N.[Номер заявки]
				--одобрено
...
BEGIN
	IF @isFill_All_Tables = 1
	BEGIN
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_Contact_DetailByEmployee
		DELETE T FROM tmp.TMP_Report_verification_fedor_Contact_DetailByEmployee AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_Contact_DetailByEmployee
		(
		    ProcessGUID,
		    [Дата заведения заявки],
		    [Время заведения],
...
BEGIN
	...
	BEGIN
		--Датасет не используется
		/*
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_VK_DetailHours
		DELETE T FROM tmp.TMP_Report_verification_fedor_VK_DetailHours AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_VK_DetailHours
		SELECT
			ProcessGUID = @ProcessGUID,
			fv.[Дата заведения заявки]
				, fv.[Время заведения]
			...
			, fv.[Время, час:мин:сек]
				...
				, ШагЧасаСтатуса = row_number() over(partition by fv.[Номер заявки], fv.ШагЗаявки order by endInterval )
				, КоличествоЗаявокВЧасе = count(fv.[Номер заявки]) over(partition by hourInterval)
		--INTO tmp.TMP_Report_verification_fedor_VK_DetailHours
		from #t_dm_FedorVerificationRequests fv--#details
		cross apply dwh2.[dbo].[times_from_interval_hours] ([Дата статуса], [Дата след.статуса],60) hr 
...
BEGIN
	...
	--BEGIN
		...
		--AND R.[Дата статуса] < @dt_to
		AND (
			R.Статус IN ('Верификация ТС','Верификация Call 4','Верификация Call 5') 
			AND R.[Статус следующий] IN ('Одобрено')
		)
		GROUP BY R.[Номер заявки]
		...
		WHERE 1=1
			--AND R.[Дата статуса] >= @dt_from
			--AND R.[Дата статуса] < @dt_to
			AND R.Статус IN ('Верификация ТС','Верификация Call 4','Верификация Call 5')
			AND R.[Статус следующий] IN ('Отказано')
			AND NOT EXISTS(SELECT TOP(1) 1 FROM #t_checklists_rejects AS J WHERE J.IdClientRequest = N.IdClientRequest)
		GROUP BY R.[Номер заявки]
	...
	IF @isFill_All_Tables = 1
	BEGIN
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_VTC_Detail
		DELETE T FROM tmp.TMP_Report_verification_fedor_VTC_Detail AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_VTC_Detail
		SELECT
			ProcessGUID = @ProcessGUID,
			R.[Дата заведения заявки]
			 , R.[Время заведения]
		   ...
		   , R.[Время, час:мин:сек]
			...
			END,
			R.Партнер
		--INTO tmp.TMP_Report_verification_fedor_VTC_Detail
		FROM #t_request_number AS N
			INNER JOIN #t_dm_FedorVerificationRequests AS R
				ON R.[Номер заявки] = N.[Номер заявки]
			--одобрено
...
BEGIN
	...
	BEGIN
		--Датасет не используется
		/*
		--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_VTC_DetailHours
		DELETE T FROM tmp.TMP_Report_verification_fedor_VTC_DetailHours AS T WHERE T.ProcessGUID = @ProcessGUID

		INSERT tmp.TMP_Report_verification_fedor_VTC_DetailHours
		SELECT
			ProcessGUID = @ProcessGUID,
			fv.[Дата заведения заявки]
				, fv.[Время заведения]
			...
			, fv.[Время, час:мин:сек]
				...
				, ШагЧасаСтатуса = row_number() over(partition by fv.[Номер заявки], fv.ШагЗаявки order by endInterval )
				, КоличествоЗаявокВЧасе = count(fv.[Номер заявки]) over(partition by hourInterval)
		--INTO tmp.TMP_Report_verification_fedor_VTC_DetailHours
		from #t_dm_FedorVerificationRequests fv--#details
		cross apply dwh2.[dbo].[times_from_interval_hours] ([Дата статуса], [Дата след.статуса],60) hr 
...
---------------------------------------------
		...
		END
		  ...
		  union all select 'Подтверждение дохода'
        ...
        -- сотрудники
          ...
          select row_number() over ( order by Employee) as [empl_id]
        		   , Employee
            into #employee_rows
            from (select distinct Работник Employee from #t_dm_FedorVerificationRequests) e
...
-- KD.%
 ...
 begin
        ...
        select * 
          into #details_KD 
          from #t_dm_FedorVerificationRequests  --where [Номер заявки]='20092400036174'
         where 1=1
 ...
 drop table if exists #ReportByEmployeeAgg_m
        ...
        begin
			...
			BEGIN
				--Датасет не используется
				/*
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_ReportByEmployee
				DELETE T FROM tmp.TMP_Report_verification_fedor_ReportByEmployee AS T WHERE T.ProcessGUID = @ProcessGUID
        
				INSERT tmp.TMP_Report_verification_fedor_ReportByEmployee
				select 
					ProcessGUID = @ProcessGUID,
					Дата
					, Сотрудник
				...
				--INTO tmp.TMP_Report_verification_fedor_ReportByEmployee
				from #fedor_verificator_report
...
--помесячная аггрегация             
	...
	BEGIN
		...
		from #fedor_verificator_report
		group by cast(format(Дата,'yyyyMM01') as date), Сотрудник

		DELETE T FROM tmp.TMP_Report_verification_fedor_KD_Monthly_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			select 
				...
				, Сумма = isnull(a.Отложена, 0)
			from #KDEmployees_m as e
				left join #ReportByEmployeeAgg_KD_m_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		...
		INSERT tmp.TMP_Report_verification_fedor_KD_Monthly_ALL
		select 
		...
		--INTO tmp.TMP_Report_verification_fedor_KD_Monthly_AR
		from agg
		union all
		select 
			ProcessGUID = @localProcessGUID,
			...
			, Сумма = format(isnull(
						case 
							when sum(ИтогоПоСотруднику)<>0 
								then sum(ВК*1.0)/sum(ИтогоПоСотруднику) 
							else 0 
						end, 0)
						* 100, '0.00')
		from agg
	...
	BEGIN
		...
		DELETE T FROM tmp.TMP_Report_verification_fedor_KD_Daily_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			from #KDEmployees as e
				left join #ReportByEmployeeAgg as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			from #KDEmployees as e
				left join #fedor_verificator_report_KD_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		...
		INSERT tmp.TMP_Report_verification_fedor_KD_Daily_ALL
		select 
			ProcessGUID = @localProcessGUID,
			empl_id
			, Employee
		...
		select 
			...
			, Indicator
			, Сумма = format(isnull(Сумма,0) * 100, '0.00')
		--INTO tmp.TMP_Report_verification_fedor_KD_Daily_AR
		from agg
		union all
		select 
			ProcessGUID = @localProcessGUID,
...
if @Page in (
	...
	'PD.Daily.Postpone',
	'PD.Daily.PostponeUnique',

	'PD.Monthly.Postpone',
	'PD.Monthly.PostponeUnique',
	...
	'PD.HoursGroupDaysUnique',
	'PD.HoursGroupDays',

	'PD.HoursGroupMonthUnique',
	'PD.HoursGroupMonth',
...
begin
	drop table if exists #fedor_verificator_report_PD
	drop table if exists #details_PD

	select * 
	into #details_PD
	from #t_dm_FedorVerificationRequests
	where 1=1
		AND Статус in ('Подтверждение дохода')
		--AND (Работник not in (select * from #curr_employee_vr) 
		--	OR Работник IN (select Employee from #curr_employee_cd)
		--)
		--and [Дата статуса]>= @dt_from and  [Дата статуса]<@dt_to
         
	create INDEX ix_Статус_Задача
	ON #details_PD([Статус] ,[Статус следующий], [Задача],[Задача следующая],[Состояние заявки], [Состояние заявки следующая])
	INCLUDE ([Номер заявки],[ФИО клиента],[Дата статуса],[ВремяЗатрачено],[ШагЗаявки],[ПоследнийШаг], [Работник],[Работник_Пред],[Работник_След])
		
	IF @isDebug = 1 BEGIN
		DROP TABLE IF EXISTS ##details_PD
		SELECT * INTO ##details_PD FROM #details_PD
	END

	/*
	--Отказы Логинома
	DELETE #t_request_number_PD
	DELETE #t_checklists_rejects_PD

	INSERT #t_request_number_PD(IdClientRequest, [Номер заявки])
	SELECT DISTINCT R.IdClientRequest, R.[Номер заявки]
	FROM #details_PD AS R
	...
	;with loginom_checklists_rejects AS(
		...
		WHERE EXISTS(SELECT TOP(1) 1 
			FROM #t_request_number_PD AS R 
			WHERE R.IdClientRequest = cli.IdClientRequest)
		GROUP BY cli.IdClientRequest
	)
	INSERT #t_checklists_rejects_PD
	(
		IdClientRequest,
		Number,
		CheckListItemTypeName,
	...
	FROM [Stg].[_fedor].[core_CheckListItem] cli
		...
		INNER JOIN Stg._fedor.core_ClientRequest AS CR
			ON CR.Id = cli.IdClientRequest
	WHERE EXISTS(SELECT TOP(1) 1 FROM #t_request_number_PD AS R WHERE R.IdClientRequest = cli.IdClientRequest)
	*/
	...
	select 'Отказано' [status]
		...
		, ВремяЗатрачено
		,ТипКлиента
	into #fedor_verificator_report_PD
	from #details_PD AS N
	where [Статус следующий]='Отказано' 
		--and Статус in('Верификация Call 1.5')
		--AND EXISTS(SELECT TOP(1) 1 FROM #t_checklists_rejects_PD AS J WHERE J.IdClientRequest = N.IdClientRequest)
	-- 
	union all
	select * from postpone
	union all 
    ...
    where 1=1
		...
		--OR (
		--	R.[Статус следующий]='Отказано' and R.Статус in('Верификация Call 1.5')
		--	AND NOT EXISTS(SELECT TOP(1) 1 FROM #t_checklists_rejects_PD AS J WHERE J.IdClientRequest = R.IdClientRequest)
		--)
	...
	--select * from  #fedor_verificator_report_PD where дата='20200922' and status like 'до%'
    CREATE NONCLUSTERED INDEX ix_ДатаИВремяСтатуса
	ON #fedor_verificator_report_PD([ДатаИВремяСтатуса])
	INCLUDE ([status],[Дата],[Номер заявки],[Сотрудник])

	IF @isDebug = 1 BEGIN
		DROP TABLE IF EXISTS ##fedor_verificator_report_PD
		SELECT * INTO ##fedor_verificator_report_PD FROM #fedor_verificator_report_PD
	END

	drop table if exists #ReportByEmployeeAgg_PD
	...
	;with c1 as (
		select Дата
			...
			, isnull(count( distinct case when status='Отложена' then  [Номер заявки] end),0) [Отложено уникальных]
			, isnull(count( distinct case when status='Доработка' then [Номер заявки] end ),0) [Доработка уникальных]
		from #fedor_verificator_report_PD
		group by Дата, Сотрудник
	)
	,c2 as (
		select [ФИО сотрудника верификации/чекер]
	...
	IF @isDebug = 1 BEGIN
		DROP TABLE IF EXISTS ##ReportByEmployeeAgg_PD
		SELECT * INTO ##ReportByEmployeeAgg_PD FROM #ReportByEmployeeAgg_PD
	END

       
	-- аггрегация за месяц       
	drop table if exists #ReportByEmployeeAgg_m_PD
	...
	;with c1 as (
		select format(Дата,'yyyyMM01') Дата
			...
			, isnull(count( distinct case when status='Доработка' then [Номер заявки] end ),0) [Доработка уникальных]
		from #fedor_verificator_report_PD
		group by format(Дата,'yyyyMM01'), Сотрудник
	)
	,c2 as (
		select [ФИО сотрудника верификации/чекер]
			, format(Дата,'yyyyMM01') дата
	...
	-- подневная аггрегация        
	drop table if exists #PDEmployees
	...
	into #PDEmployees
	from #employee_rows_d
	where [Status] in ('Подтверждение дохода') 
		and Employee in (select * from #curr_employee_cd)


	--помесячная аггрегация             
	drop table if exists #PDEmployees_m
	...
	--DWH-241
	--отображение единого матричного отчета по месяцам (показатели - в столбцах)
	IF @Page = 'PD.Monthly.ALL' OR @isFill_All_Tables = 1
	BEGIN
		IF @isFill_All_Tables = 1 BEGIN
			select @localProcessGUID = @ProcessGUID
		END
		...
		drop table if exists #ReportByEmployeeAgg_PD_m_Unique2
		select 
			Дата = cast(format(Дата,'yyyyMM01') as date)
			, Сотрудник             
			, Отложена = isnull(count( distinct case when status='Отложена' then [Номер заявки]  end),0) 
		into #ReportByEmployeeAgg_PD_m_Unique2
		from #fedor_verificator_report_PD
		group by cast(format(Дата,'yyyyMM01') as date), Сотрудник

		DELETE T FROM tmp.TMP_Report_verification_fedor_PD_Monthly_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			select 
				...
				, Indicator = '1. Кол-во заявок'
				, Сумма = isnull(a.КоличествоЗаявок, 0)
			from #PDEmployees_m e
				left join #ReportByEmployeeAgg_m_PD a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, Indicator = '2. Кол-во уникальных заявок'
				, Сумма = isnull(a.ИтогоПоСотруднику, 0)
			from #PDEmployees_m as e
				left join #ReportByEmployeeAgg_m_PD as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, Сумма = isnull(a.Отложена, 0)
			from #PDEmployees_m as e
				left join #ReportByEmployeeAgg_PD_m_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		...
		INSERT tmp.TMP_Report_verification_fedor_PD_Monthly_ALL
		select 
			ProcessGUID = @localProcessGUID,
			empl_id
			, Employee
		...
		select 
			ProcessGUID = @localProcessGUID,
			empl_id = isnull((select max(empl_id) from #PDEmployees_m),0)+ 1
			, Employee ='ИТОГО'
			, dt 
			, indicator
			, Сумма = format(sum(Сумма), '0')
		...
		select 
			...
			, Indicator
			, Сумма = format(isnull(Сумма,0) * 100, '0.00')
		--INTO tmp.TMP_Report_verification_fedor_PD_Monthly_AR
		from agg
		union all
		select 
			ProcessGUID = @localProcessGUID,
		...
		BEGIN
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PD.Monthly.ALL', @localProcessGUID
		END
		ELSE BEGIN
			select T.empl_id, T.Employee, T.dt, T.indicator, T.Сумма
			from tmp.TMP_Report_verification_fedor_PD_Monthly_ALL as T
	...
	IF @Page = 'PD.Daily.ALL' OR @isFill_All_Tables = 1
	BEGIN
		IF @isFill_All_Tables = 1 BEGIN
			select @localProcessGUID = @ProcessGUID
		END
		...
		drop table if exists #fedor_verificator_report_PD_Unique2

		select
			Дата
			,Сотрудник              
			,ОтложенаУникальные = isnull(count(distinct case when status='Отложена' then [Номер заявки] end),0) 
		into #fedor_verificator_report_PD_Unique2
		from #fedor_verificator_report_PD
		group by Дата, Сотрудник

		DELETE T FROM tmp.TMP_Report_verification_fedor_PD_Daily_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			select 
				...
				, Сумма = isnull(a.КоличествоЗаявок, 0)
			from #PDEmployees e
				left join #ReportByEmployeeAgg_PD a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, Indicator = '2. Кол-во уникальных заявок'
				, Сумма = isnull(a.ИтогоПоСотруднику, 0)
			from #PDEmployees as e
				left join #ReportByEmployeeAgg_PD as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, Сумма = isnull(a.ОтложенаУникальные, 0)
			from #PDEmployees as e
				left join #fedor_verificator_report_PD_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		...
		INSERT tmp.TMP_Report_verification_fedor_PD_Daily_ALL
		select 
			ProcessGUID = @localProcessGUID,
			empl_id
			, Employee
		...
		select 
			ProcessGUID = @localProcessGUID,
			empl_id = isnull((select max(empl_id) from #PDEmployees),0)+ 1
			, Employee ='ИТОГО'
			, dt 
			, indicator
			, Сумма = format(sum(Сумма), '0')
		...
		select 
			...
			, Indicator
			, Сумма = format(isnull(Сумма,0) * 100, '0.00')
		--INTO tmp.TMP_Report_verification_fedor_PD_Daily_AR
		from agg
		union all
		select 
			ProcessGUID = @localProcessGUID,
		...
		BEGIN
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PD.Daily.ALL', @localProcessGUID
		END
		ELSE BEGIN
			select T.empl_id, T.Employee, T.dt, T.indicator, T.Сумма
			from tmp.TMP_Report_verification_fedor_PD_Daily_ALL as T
...
if @Page in (
	...
	'PSV.HoursGroupDaysUnique',
	'PSV.HoursGroupDays',

	'PSV.HoursGroupMonthUnique',
	'PSV.HoursGroupMonth',
...
begin
	...
	BEGIN
		...
		DELETE T FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			from #PSVEmployees_m e
				left join #ReportByEmployeeAgg_m_PSV a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			from #PSVEmployees_m as e
				left join #ReportByEmployeeAgg_m_PSV as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, Сумма = isnull(a.Отложена, 0)
			from #PSVEmployees_m as e
				left join #ReportByEmployeeAgg_PSV_m_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		...
		INSERT tmp.TMP_Report_verification_fedor_PSV_Monthly_ALL
		select 
			ProcessGUID = @localProcessGUID,
			empl_id
			, Employee
		...
		select 
			ProcessGUID = @localProcessGUID,
			empl_id = isnull((select max(empl_id) from #PSVEmployees_m),0)+ 1
			, Employee ='ИТОГО'
			, dt 
			, indicator
			, Сумма = format(sum(Сумма), '0')
	...
	BEGIN
		...
		DELETE T FROM tmp.TMP_Report_verification_fedor_PSV_Daily_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			select 
				...
				, Сумма = isnull(a.КоличествоЗаявок, 0)
			from #PSVEmployees e
				left join #ReportByEmployeeAgg_PSV a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			from #PSVEmployees as e
				left join #ReportByEmployeeAgg_PSV as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, Сумма = isnull(a.ОтложенаУникальные, 0)
			from #PSVEmployees as e
				left join #fedor_verificator_report_PSV_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		...
		INSERT tmp.TMP_Report_verification_fedor_PSV_Daily_ALL
		select 
			ProcessGUID = @localProcessGUID,
			empl_id
			, Employee
		...
		select 
			ProcessGUID = @localProcessGUID,
			empl_id = isnull((select max(empl_id) from #PSVEmployees),0)+ 1
			, Employee ='ИТОГО'
			, dt 
			, indicator
			, Сумма = format(sum(Сумма), '0')
		...
		select 
			...
			, Indicator
			, Сумма = format(isnull(Сумма,0) * 100, '0.00')
		--INTO tmp.TMP_Report_verification_fedor_PSV_Daily_AR
		from agg
		union all
		select 
			ProcessGUID = @localProcessGUID,
         ...
         select 
			...
			, Контактность = 
				iif(
					...
					1, 0)
         into #details_VK
         from #t_dm_FedorVerificationRequests AS R /*#details*/
		 WHERE 1=1
		...
		--отказано сотрудником
         ...
         select Статус 
          ...
          where  [Номер заявки]='20091600033895' 
           ...
           -- select * from #t_dm_FedorVerificationRequests where [Номер заявки]='20091600033794'  
...
-- считаем уникальных отложенных по верификации
		...
		BEGIN
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_VK_HoursGroupDaysUnique
				DELETE T FROM tmp.TMP_Report_verification_fedor_VK_HoursGroupDaysUnique AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_VK_HoursGroupDaysUnique
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_VK_HoursGroupDaysUnique
		...
		BEGIN
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_VK_HoursGroupDays
				DELETE T FROM tmp.TMP_Report_verification_fedor_VK_HoursGroupDays AS T WHERE T.ProcessGUID = @ProcessGUID
		...
		c3 as (
				...
				INSERT tmp.TMP_Report_verification_fedor_VK_HoursGroupDays
				SELECT 
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_VK_HoursGroupDays
				from (select distinct Интервал, cast(Дата as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
				select c2.Интервал
					, дата
  ...
  begin
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_VK_HoursGroupMonthUnique
				DELETE T FROM tmp.TMP_Report_verification_fedor_VK_HoursGroupMonthUnique AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_VK_HoursGroupMonthUnique
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_VK_HoursGroupMonthUnique
    ...
    -- Лист "VK. Общее количество по часам"
		...
		BEGIN
			IF @isFill_All_Tables = 1
  begin
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_VK_HoursGroupMonth
				DELETE T FROM tmp.TMP_Report_verification_fedor_VK_HoursGroupMonth AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_VK_HoursGroupMonth
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_VK_HoursGroupMonth
				from (select distinct Интервал, cast(format(Дата,'yyyyMM01') as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
				select c2.Интервал
					, дата
	...
	--DWH-241
	--отображение единого матричного отчета по месяцам (показатели - в столбцах)
	IF @Page = 'VK.Monthly.ALL' OR @isFill_All_Tables = 1
	BEGIN
		IF @isFill_All_Tables = 1 BEGIN
			select @localProcessGUID = @ProcessGUID
		END
		...
		drop table if exists #ReportByEmployeeAgg_VK_m_Unique2
		select 
			Дата = cast(format(Дата,'yyyyMM01') as date)
			, Сотрудник             
			, Отложена = isnull(count( distinct case when status='Отложена' then [Номер заявки]  end),0) 
		into #ReportByEmployeeAgg_VK_m_Unique2
		from #fedor_verificator_report_VK
		group by cast(format(Дата,'yyyyMM01') as date), Сотрудник

		DELETE T FROM tmp.TMP_Report_verification_fedor_VK_Monthly_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			select 
				...
				, e.Employee		
				, dt = e.acc_period  
				, Indicator = '02. Кол-во уникальных заявок'
				, Сумма = isnull(a.ИтогоПоСотруднику, 0)
			from #VKEmployees_m as e
				left join #ReportByEmployeeAgg_VK_m as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, e.Employee		
				, dt = e.acc_period  
				, Indicator = '04. Кол-во одобренных заявок'
				, Сумма = isnull(a.VTS, 0)
			from #VKEmployees_m as e
				left join #ReportByEmployeeAgg_VK_m as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, e.Employee		
				, dt = e.acc_period  
				, Indicator = '06. Кол-во отложенных заявок'
				, Сумма = isnull(a.Отложена, 0)
			from #VKEmployees_m as e
				left join #ReportByEmployeeAgg_VK_m as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, e.Employee		
				, dt = e.acc_period  
				, Indicator = '07. Кол-во уникальных отложенных заявок' 
				, Сумма = isnull(a.Отложена, 0)
			from #VKEmployees_m as e
				left join #ReportByEmployeeAgg_VK_m_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, e.Employee		
				, dt = e.acc_period  
				, Indicator = '08. Кол-во заявок, отправленных на доработку'
				, Сумма = isnull(a.Доработка, 0)
			from #VKEmployees_m as e
				left join #ReportByEmployeeAgg_VK_m as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		)
		INSERT tmp.TMP_Report_verification_fedor_VK_Monthly_ALL
		select 
			ProcessGUID = @localProcessGUID,
			empl_id
			, Employee
		...
		;with agg as (
			select 
				...
				, a.ВремяЗатрачено
				, a.КоличествоЗаявок
				, Indicator = '03. Ср. время обработки одной заявки'
				, Сумма = case when a.КоличествоЗаявок<>0 then a.ВремяЗатрачено/a.КоличествоЗаявок else 0 end 
			from #VKEmployees_m as e
				left join #ReportByEmployeeAgg_VK_m as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		)
		...
		;with agg as (
			select 
				...
				, e.Employee		
				, dt = e.acc_period
				, Indicator = '05. Approval Rate (%)'
				, a.VTS
				, a.ИтогоПоСотруднику
				, Сумма = case when a.ИтогоПоСотруднику<>0 then a.VTS * 1.0 / a.ИтогоПоСотруднику else 0 end
			from #VKEmployees_m as e
				left join #ReportByEmployeeAgg_VK_m as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		)
		INSERT tmp.TMP_Report_verification_fedor_VK_Monthly_ALL
		select 
			...
			, Indicator
			, Сумма = format(isnull(Сумма,0) * 100, '0.00')
		--INTO tmp.TMP_Report_verification_fedor_VK_Monthly_AR
		from agg
		union all
		select 
			ProcessGUID = @localProcessGUID,
			...
			, Сумма = format(isnull(
						case 
							when sum(ИтогоПоСотруднику)<>0 
								then sum(VTS * 1.0) / sum(ИтогоПоСотруднику)
							else 0 
						end, 0)
						* 100, '0.00')
		from agg
		...
		select 
			...
			, Сумма = case when a.УникальныхЗаявок <> 0 then a.Контактность * 1.0 / a.УникальныхЗаявок else 0 end
		FROM #VKEmployees_m AS e
		...
		SELECT
			...
			, Сумма = format(isnull(
						case 
							when sum(УникальныхЗаявок)<>0 
								then sum(Контактность * 1.0)/sum(УникальныхЗаявок) 
							else 0 
						end, 0)
						* 100, '0.00')
		from agg
		...
		select 
			...
			, e.Employee		
			, dt = e.acc_period
			, Indicator = '10. Контактность по одобренным (%)'
			, a.Контактность
			--, КоличествоЗаявок
			--, ИтогоПоСотруднику
			, a.УникальныхЗаявок
		...
		select 
			...
			, e.Employee		
			, dt = e.acc_period
			, Indicator = '11. Контактность по отказным (%)'
			, a.Контактность
			--, КоличествоЗаявок
			--, ИтогоПоСотруднику
			, a.УникальныхЗаявок
		...
		BEGIN
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'VK.Monthly.ALL', @localProcessGUID
		END
		ELSE BEGIN
			select T.empl_id, T.Employee, T.dt, T.indicator, T.Сумма
			from tmp.TMP_Report_verification_fedor_VK_Monthly_ALL as T
	...
	IF @Page = 'VK.Daily.ALL' OR @isFill_All_Tables = 1
	BEGIN
		IF @isFill_All_Tables = 1 BEGIN
			select @localProcessGUID = @ProcessGUID
		END
		...
		drop table if exists #fedor_verificator_report_VK_Unique2
		select Дата
			, Сотрудник              
			, ОтложенаУникальные = isnull(count(distinct case when status='Отложена' then [Номер заявки]  end),0)
		into #fedor_verificator_report_VK_Unique2
		from #fedor_verificator_report_VK
		group by Дата, Сотрудник


		DELETE T FROM tmp.TMP_Report_verification_fedor_VK_Daily_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			from #VKEmployees as e
				left join #ReportByEmployeeAgg_VK as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, Сумма = isnull(a.ОтложенаУникальные, 0)
			from #VKEmployees as e
				left join #fedor_verificator_report_VK_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		...
		INSERT tmp.TMP_Report_verification_fedor_VK_Daily_ALL
		select 
			ProcessGUID = @localProcessGUID,
			empl_id
			, Employee
		...
		select 
			...
			, Indicator
			, Сумма = format(isnull(Сумма,0) * 100, '0.00')
		--INTO tmp.TMP_Report_verification_fedor_VK_Daily_AR
		from agg
		union all
		select 
			ProcessGUID = @localProcessGUID,
		...
		BEGIN
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'VK.Daily.ALL', @localProcessGUID
		END
		ELSE BEGIN
			select T.empl_id, T.Employee, T.dt, T.indicator, T.Сумма
			from tmp.TMP_Report_verification_fedor_VK_Daily_ALL as T
	...
	drop table if exists    #TSEmployees
       ...
       drop table if exists    #TSEmployees_m
		...
		select top(0)
			...
			, Дата = cast([Дата статуса] as date) 
			, ДатаИВремяСтатуса = [Дата статуса] 
			, [ФИО клиента]
			, [Номер заявки] 
			--, Сотрудник=СотрудникПоследнегоСтатуса
			--, [ФИО сотрудника верификации/чекер]
		...
		begin
			...
			insert #fedor_verificator_report_TS
			   -- доработка
			  select [status]
				   ,  Дата
				   , [Дата статуса] ДатаИВремяСтатуса
		...
		-- для прочих типов
			 ...
			 with 
				--details_TS as (
				--	SELECT * from #t_dm_FedorVerificationRequests/*#details*/ 
				--	WHERE 1=1
				--	--AND Работник not in (select * from #curr_employee_cd)
				--	AND (Работник not in (select * from #curr_employee_cd)
				--		OR Работник IN (select Employee from #curr_employee_vr) --DWH-1620. 2022-04-06
		   ...
		   select * from postpone1
			...
			--select * from  #fedor_verificator_report_TS where  Дата='20200916'  order by 2 
			 ...
			 select 'Отказано' [status]
				...
				from #details_TS AS N
			   where [Статус следующий]='Отказано' 
					and (Статус in('Верификация ТС') or Статус in('Верификация Call 4'))
					--and Статус in ('Верификация ТС','Верификация Call 4','Верификация Call 5')
					AND EXISTS(SELECT TOP(1) 1 FROM #t_checklists_rejects AS J WHERE J.IdClientRequest = N.IdClientRequest)
			 */
			 --DWH-241
			select [status]
			...
			from (
				select 'Отказано' [status]
					...
					,ТипКлиента
					, rn = row_number() over (
						partition by [Номер заявки]
						order by ШагЗаявки desc
					)
				from #details_TS AS D
				where 1=1
					and Статус in ('Верификация ТС')
					--дальше было 'Верификация Call 4', 'Верификация Call 5' и след. статус 'Отказано'
					AND EXISTS(
							SELECT TOP(1) 1
							FROM #details_TS AS P
							WHERE P.[Номер заявки] = D.[Номер заявки]
								--AND P.ШагЗаявки = D.ШагЗаявки + ?
								AND P.[Дата статуса] >= D.[Дата статуса]
								--AND P.Статус in ('Верификация Call 5')
								--AND P.Статус in ('Верификация Call 4')
								--AND P.Статус in ('Верификация ТС')
								AND P.Статус in ('Верификация Call 4', 'Верификация Call 5')
								AND P.[Статус следующий]='Отказано'
								AND EXISTS(
									SELECT TOP(1) 1 
									FROM #t_checklists_rejects AS J 
									WHERE J.IdClientRequest = P.IdClientRequest)
						)
				) as a
				where a.rn = 1
				   ...
				   union
					...
					--
				/*    
					select * from #t_dm_FedorVerificationRequests where [Номер заявки] in (
					select distinct [Номер заявки] from #t_dm_FedorVerificationRequests where   Статус in('Верификация ТС')
					)
					order by [Номер заявки], [Дата статуса]
					*/
			  select 'Новая' [status]
			 ...
			 select Статус 
			  ...
			  where  [Номер заявки]='20091600033895' 
			   ...
			   -- select * from #t_dm_FedorVerificationRequests where Статус like 'Договор%'
			  -- select * from #t_dm_FedorVerificationRequests where Статус like 'отк%'
			--select * from #t_dm_FedorVerificationRequests where [Номер заявки]='20090900032034'
			   -- select * from  #fedor_verificator_report_TS where  status='Отказано' and  Дата='20200916' --[Номер заявки]='20091500033541' order by 3
			  ...
			  select 'Одобрено' [status]
				   ...
				   , ВремяЗатрачено 
					,ТипКлиента
				from #details_TS AS D
			   where [Статус следующий]='Одобрено' 
					--and (Статус in('Верификация ТС') or Статус in('Верификация Call 4'))
					and Статус in ('Верификация ТС','Верификация Call 4','Верификация Call 5')
					--DWH-2429 --одобрено сотрудником, но отказано автоматически
					OR (
						D.[Статус следующий]='Отказано' 
						--and (Статус in('Верификация ТС') or Статус in('Верификация Call 4'))
						and Статус in ('Верификация ТС','Верификация Call 4','Верификация Call 5')
						AND NOT EXISTS(SELECT TOP(1) 1 FROM #t_checklists_rejects AS J WHERE J.IdClientRequest = D.IdClientRequest)
					)
				*/
				...
				from (
				  select 'Одобрено' [status]
				   ...
				   where 1=1
						and Статус in ('Верификация ТС')
						--and Статус in ('Верификация ТС', 'Верификация Call 4')
						--and Статус in ('Верификация ТС', 'Верификация Call 4', 'Верификация Call 5')
						--and [Статус следующий]='Одобрено' 
						AND (
							--дальше было 'Верификация Call 5' и след. статус 'Одобрено'
							EXISTS(
								SELECT TOP(1) 1
								FROM #details_TS AS P
								WHERE P.[Номер заявки] = D.[Номер заявки]
									...
									AND P.[Дата статуса] >= D.[Дата статуса]
									AND P.Статус in ('Верификация Call 5')
									--AND P.[Статус следующий]='Одобрено' 
							)
							or
							(
								--дальше было 'Верификация Call 5' 
								--и потом одобрено сотрудником, но отказано автоматически
								EXISTS(
									SELECT TOP(1) 1
									FROM #details_TS AS P
									WHERE P.[Номер заявки] = D.[Номер заявки]
		...
		create table #ReportByEmployeeAgg_TS
		(
			Дата date
			, Сотрудник nvarchar(100)
			, ИтогоПоСотруднику int
			, VTS int
			, Одобрено int
			, [Доработка] int
			, [Отказано] int
			, [Отложена] int
			, Новая int
			, Новая_Уникальная int
			, [Новая_Уникальная Первичный] int
			, [Новая_Уникальная Повторный] int
			, [Новая_Уникальная Докредитование] int
			, [Новая_Уникальная Параллельный] int
			, [Новая_Уникальная Не определен] int
			, [Отложено уникальных] int
			, [Доработка уникальных] int
			, КоличествоЗаявок int
			, ВремяЗатрачено decimal(38,10)
			, AvgВремяЗатрачено decimal(38,10)
		)
		...
		IF @isDebug = 1 BEGIN
			DROP TABLE IF EXISTS ##ReportByEmployeeAgg_TS
			SELECT * INTO ##ReportByEmployeeAgg_TS FROM #ReportByEmployeeAgg_TS
		END
...
--Monthly
		...
		create table #ReportByEmployeeAgg_TS_m
		(
			Дата date
			, Сотрудник nvarchar(100)
			, ИтогоПоСотруднику int
		...
		begin
			...
			insert #ReportByEmployeeAgg_TS_m
			  select c1.*
				   , isnull(c2.КоличествоЗаявок,0) КоличествоЗаявок 
				   , isnull(c2.ВремяЗатрачено,0) ВремяЗатрачено
				   , isnull(c2.AvgВремяЗатрачено,0) AvgВремяЗатрачено
		...
		IF @isDebug = 1 BEGIN
			DROP TABLE IF EXISTS ##ReportByEmployeeAgg_TS_m
			SELECT * INTO ##ReportByEmployeeAgg_TS_m FROM #ReportByEmployeeAgg_TS_m
		END
		...
		BEGIN
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_TS_HoursGroupDaysUnique
				DELETE T FROM tmp.TMP_Report_verification_fedor_TS_HoursGroupDaysUnique AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_TS_HoursGroupDaysUnique
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_TS_HoursGroupDaysUnique
				from (select distinct Интервал, cast(Дата as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
				select c2.Интервал
					, дата
		...
		BEGIN
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_TS_HoursGroupDays
				DELETE T FROM tmp.TMP_Report_verification_fedor_TS_HoursGroupDays AS T WHERE T.ProcessGUID = @ProcessGUID
		...
		c3 as (
				...
				INSERT tmp.TMP_Report_verification_fedor_TS_HoursGroupDays
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_TS_HoursGroupDays
				from (select distinct Интервал, cast(Дата as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
				select c2.Интервал
					, дата
		...
		BEGIN
			IF @isFill_All_Tables = 1
  begin
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_TS_HoursGroupMonthUnique
				DELETE T FROM tmp.TMP_Report_verification_fedor_TS_HoursGroupMonthUnique AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_TS_HoursGroupMonthUnique
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_TS_HoursGroupMonthUnique
  ...
  begin
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_TS_HoursGroupMonth
				DELETE T FROM tmp.TMP_Report_verification_fedor_TS_HoursGroupMonth AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_TS_HoursGroupMonth
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_TS_HoursGroupMonth
				from (select distinct Интервал, cast(format(Дата,'yyyyMM01') as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
	...
	--DWH-241
	--отображение единого матричного отчета по месяцам (показатели - в столбцах)
	IF @Page = 'TS.Monthly.ALL' OR @isFill_All_Tables = 1
	BEGIN
		IF @isFill_All_Tables = 1 BEGIN
			select @localProcessGUID = @ProcessGUID
		END
		...
		drop table if exists #ReportByEmployeeAgg_TS_m_Unique2
		select 
			Дата = cast(format(Дата,'yyyyMM01') as date)
			, Сотрудник             
			, Отложена = isnull(count( distinct case when status='Отложена' then [Номер заявки]  end),0) 
		into #ReportByEmployeeAgg_TS_m_Unique2
		from #fedor_verificator_report_TS
		group by cast(format(Дата,'yyyyMM01') as date), Сотрудник

		DELETE T FROM tmp.TMP_Report_verification_fedor_TS_Monthly_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			select 
				...
				, Indicator = '2. Кол-во уникальных заявок'
				, Сумма = isnull(a.ИтогоПоСотруднику, 0)
			from #TSEmployees_m as e
				left join #ReportByEmployeeAgg_TS_m as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, Сумма = isnull(a.Отложена, 0)
			from #TSEmployees_m as e
				left join #ReportByEmployeeAgg_TS_m_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		...
		INSERT tmp.TMP_Report_verification_fedor_TS_Monthly_ALL
		select 
			ProcessGUID = @localProcessGUID,
			empl_id
			, Employee
		...
		;with agg as (
			select 
				...
				, a.Одобрено
				, a.ИтогоПоСотруднику
				, Сумма = case when a.ИтогоПоСотруднику<>0 then a.Одобрено *1.0 / a.ИтогоПоСотруднику else 0 end
			from #TSEmployees_m as e
				left join #ReportByEmployeeAgg_TS_m as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		)
		INSERT tmp.TMP_Report_verification_fedor_TS_Monthly_ALL
		...
		select 
			...
			, Сумма = format(isnull(
						case 
							when sum(ИтогоПоСотруднику)<>0 
								then sum(Одобрено * 1.0) / sum(ИтогоПоСотруднику)
							else 0 
						end, 0)
						* 100, '0.00')
		from agg
		...
		BEGIN
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'TS.Monthly.ALL', @localProcessGUID
		END
		ELSE BEGIN
			select T.empl_id, T.Employee, T.dt, T.indicator, T.Сумма
			from tmp.TMP_Report_verification_fedor_TS_Monthly_ALL as T
	...
	IF @Page = 'TS.Daily.ALL' OR @isFill_All_Tables = 1
	BEGIN
		IF @isFill_All_Tables = 1 BEGIN
			select @localProcessGUID = @ProcessGUID
		END
		...
		drop table if exists #fedor_verificator_report_TS_Unique2
		select Дата
			, Сотрудник              
			, ОтложенаУникальные = isnull(count(distinct case when status='Отложена' then [Номер заявки]  end),0)
		into #fedor_verificator_report_TS_Unique2
		from #fedor_verificator_report_TS
		group by Дата, Сотрудник

		DELETE T FROM tmp.TMP_Report_verification_fedor_TS_Daily_ALL AS T WHERE T.ProcessGUID = @localProcessGUID
		...
		;with agg as (
			...
			select 
				...
				, Indicator = '2. Кол-во уникальных заявок'
				, Сумма = isnull(a.ИтогоПоСотруднику, 0)
			from #TSEmployees as e
				left join #ReportByEmployeeAgg_TS as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
			...
			select 
				...
				, Сумма = isnull(a.ОтложенаУникальные, 0)
			from #TSEmployees as e
				left join #fedor_verificator_report_TS_Unique2 as a on e.acc_period=a.Дата and e.Employee=a.Сотрудник
		...
		INSERT tmp.TMP_Report_verification_fedor_TS_Daily_ALL
		select 
			ProcessGUID = @localProcessGUID,
			empl_id
			, Employee
		...
		BEGIN
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'TS.Daily.ALL', @localProcessGUID
		END
		ELSE BEGIN
			select T.empl_id, T.Employee, T.dt, T.indicator, T.Сумма
			from tmp.TMP_Report_verification_fedor_TS_Daily_ALL as T
...
begin
  ...
  values
	...
	--1
	--, (41 ,'Справка 2-НДФЛ')
	, (41 ,'Из них проверка "Справка 2-НДФЛ"')
	--2
	--, (42 ,'Выписка по счету из банка бумажный или эл. вид')
	, (42 ,'Из них "Выписка по счету из банка бумажный или эл. Вид"')
	--3
	--, (43 ,'Пенсионное удостоверение / Справка о размере пенсии')
	, (43 ,'Из них "Пенсионное удостоверение / Справка о размере пенсии"')
	--4
	--, (44 ,'Справка из ПФР/СФР о размере устан. пенсии')
	, (44 ,'Из них "Справка из ПФР/СФР о размере устан. пенсии"')
	--5
	--, (45 ,'Справка по форме банка/работодателя')
	, (45 ,'Из них "Справка по форме банка/работодателя"')

	--6 нет документа в Stg._fedor.dictionary_IncomeVerificationSource ?
	--, (46 ,'Выписка со счета, на который зачисляются официальные выплаты')
	--7
...
exec Reports.dbo.Report_verification_fedor 'KD.Monthly.Common'
exec Reports.dbo.Report_verification_fedor 'V.Monthly.Common'
...
*/
	...
	BEGIN
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_KD_HoursGroupDaysUnique
				DELETE T FROM tmp.TMP_Report_verification_fedor_KD_HoursGroupDaysUnique AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_KD_HoursGroupDaysUnique
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_KD_HoursGroupDaysUnique
				from (select distinct Интервал, cast(Дата as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
	...
	BEGIN
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_KD_HoursGroupDays
				DELETE T FROM tmp.TMP_Report_verification_fedor_KD_HoursGroupDays AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_KD_HoursGroupDays
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_KD_HoursGroupDays
				FROM (select distinct Интервал, cast(Дата as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
	...
	BEGIN
			IF @isFill_All_Tables = 1
  begin
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_KD_HoursGroupMonthUnique
				DELETE T FROM tmp.TMP_Report_verification_fedor_KD_HoursGroupMonthUnique AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_KD_HoursGroupMonthUnique
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, hd.ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_KD_HoursGroupMonthUnique
				FROM (select distinct Интервал, cast(format(Дата,'yyyyMM01') as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
  ...
  begin
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_KD_HoursGroupMonth
				DELETE T FROM tmp.TMP_Report_verification_fedor_KD_HoursGroupMonth AS T WHERE T.ProcessGUID = @ProcessGUID
				...
				INSERT tmp.TMP_Report_verification_fedor_KD_HoursGroupMonth
				SELECT
					ProcessGUID = @ProcessGUID,
					isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
				--INTO tmp.TMP_Report_verification_fedor_KD_HoursGroupMonth
				FROM (select distinct Интервал, cast(format(Дата,'yyyyMM01') as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
...
from #t_dm_FedorVerificationRequests r
...
from #ReportByEmployeeAgg_KD_UniquePostone p
 group by cast(([Дата]) as date)
  ...
  select [Дата заведения заявки] 
    ...
    where  1=1
		and [Дата статуса] >= @dt_from and  [Дата статуса]<@dt_to
		and [Дата заведения заявки] >= @dt_from and [Дата заведения заявки] < @dt_to
   group by [Дата заведения заявки] 
	...
	END
		...
		SELECT 
			...
			, count(distinct 
						case when D.[Тип документа подтверждающего доход] is not null 
							then D.[Номер заявки] 
						else null 
						end
					) as ПроверкаДохода
			...
			, count(distinct 
				case 
					when D.[Тип документа подтверждающего доход] like '%Справка 2-НДФЛ%'
					then D.[Номер заявки] 
				else null 
			...
			, count(distinct 
				case 
					when D.[Тип документа подтверждающего доход] like '%Выписка по счету из банка бумажный или эл. вид%'
					then D.[Номер заявки] 
				else null 
			...
			, count(distinct 
				case 
					when D.[Тип документа подтверждающего доход] like '%Справка по форме банка/работодателя%'
					then D.[Номер заявки] 
				else null 
			...
			, count(distinct 
				case 
					when D.[Тип документа подтверждающего доход] like '%Выписка со счета, на который зачисляются официальные выплаты%'
					then D.[Номер заявки] 
				else null 
			...
			, count(distinct 
				case 
					when D.[Тип документа подтверждающего доход] like '%Справка из ПФР/СФР о размере устан. пенсии%'
					then D.[Номер заявки] 
				else null 
			...
			, count(distinct 
				case 
					when D.[Тип документа подтверждающего доход] like '%Пенсионное удостоверение / Справка о размере пенсии%'
					then D.[Номер заявки] 
				else null 
			...
			, count(distinct 
				case 
					when D.[Тип документа подтверждающего доход] like '%Справка по налогу на профессиональный доход%'
					then D.[Номер заявки] 
				else null 
		...
		from (
			...
			from #t_dm_FedorVerificationRequests AS A
			where 1=1
  ...
  , [Уникальное кол-во отложенных заявок на этапе] = cast(format((u.ОтложенаУникальныеKD),'0') as nvarchar(50))
		...
		, cast(format(isnull(new.[Общее кол-во уникальных заявок на этапе] - isnull(iv.ПроверкаДохода,0),0),'0') as nvarchar(50)) 
...
from #all_requests as r 
	...
	on r.[Дата заведения заявки] = d.Дата
  ...
  select Дата, indicator, Qty 
    ...
    select Дата
		...
		, [Не определен]
         ...
         , [TTY  - количество заявок рассмотренных в течение 6 минут на этапе] = isnull([TTY  - количество заявок рассмотренных в течение 6 минут на этапе], '0')
         , [TTY  - % заявок рассмотренных в течение 6 минут на этапе] = isnull([TTY  - % заявок рассмотренных в течение 6 минут на этапе], '0')
		...
		, [Из них проверка "Справка 2-НДФЛ"]
		, [Из них "Выписка по счету из банка бумажный или эл. Вид"]
		, [Из них "Пенсионное удостоверение / Справка о размере пенсии"]
		, [Из них "Справка из ПФР/СФР о размере устан. пенсии"]
		, [Из них "Справка по форме банка/работодателя"]
      from #p
...
unpivot
  (Qty for indicator in (
		...
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_KD_Daily_Common
			DELETE T FROM tmp.TMP_Report_verification_fedor_KD_Daily_Common AS T WHERE T.ProcessGUID = @ProcessGUID

			INSERT tmp.TMP_Report_verification_fedor_KD_Daily_Common
			SELECT
				ProcessGUID = @ProcessGUID,
				i.num_rows 
        ...
        , [Сумма] =null
	      ...
	      , Tm_Qty =null--isnull(Tm_Qty,0.00)
			--INTO tmp.TMP_Report_verification_fedor_KD_Daily_Common
    from #unp u 
...
-- Пришло на call2
 ...
 into #call2
 from #t_dm_FedorVerificationRequests r where Статус ='Верификация Call 2'  
	--and [Дата статуса]>= @dt_from and  [Дата статуса]<@dt_to
 group by cast([Дата статуса] as date)
...
select d.* 
, [Среднее время заявки в ожидании очереди на этапе Вериф.клиента]              = cast(
  ...
  as nvarchar(50))
	...
	, new.[Не определен ВК]
       ...
       cast(format(case when  [Общее кол-во заявок на этапе Вериф.клиента]<>0 then 100.0*tty.cnt/ [Общее кол-во заявок на этапе Вериф.клиента] else 0 end,'0')+N'%' as nvarchar(50))
    else '0' end
...
from(
 ...
 left join (
	...
	LEFT JOIN (
		...
		from #t_dm_FedorVerificationRequests AS D
		WHERE 1=1
...
from  (
  select Дата
       ...
       , [Средний Processing time на этапе (время обработки заявки) Вериф.ТС]          = case when sum(КоличествоЗаявок)<>0 then 
                                                                                          cast(isnull(convert(nvarchar,cast((sum(ВремяЗатрачено)/sum(КоличествоЗаявок)) as datetime),8)  ,0) as nvarchar(50))
                                                                                         else '0'
                                                                                         end
  ...
  select Дата, indicator, Qty 
    ...
    select v.Дата
		...
		, v.[Не определен ВК]
         ...
         , [Среднее время заявки в ожидании очереди на этапе Вериф.клиента] = isnull(v.[Среднее время заявки в ожидании очереди на этапе Вериф.клиента], '0')
		...
		, [Не определен ВТС] = isnull(t.[Не определен ВТС], '0')
         ...
         , [Среднее время заявки в ожидании очереди на этапе Вериф.ТС] = isnull(t.[Среднее время заявки в ожидании очереди на этапе Вериф.ТС], '0')
         , [Средний Processing time на этапе (время обработки заявки) Вериф.ТС] = isnull(t.[Средний Processing time на этапе (время обработки заявки) Вериф.ТС], '0')
...
unpivot
  (Qty for indicator in (
		...
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_V_Daily_Common
			DELETE T FROM tmp.TMP_Report_verification_fedor_V_Daily_Common AS T WHERE T.ProcessGUID = @ProcessGUID

			INSERT tmp.TMP_Report_verification_fedor_V_Daily_Common
			SELECT
				ProcessGUID = @ProcessGUID,
				i.num_rows 
				--num_rows = replace(convert(varchar(10), i.num_rows), '.0','')
				...
				, Qty_dist=null
				, Tm_Qty =null--isnull(Tm_Qty,0.00)
				--INTO tmp.TMP_Report_verification_fedor_V_Daily_Common
 ...
 drop table if exists #all_requests_m
  ...
  select [Дата заведения заявки] =format([Дата заведения заявки] ,'yyyyMM01')
   ...
   group by format([Дата заведения заявки] ,'yyyyMM01')
		...
		where 1=1
			and D.Дата >= @dt_from and D.Дата < @dt_to
		group by cast(format(D.Дата ,'yyyyMM01') as date)
...
unpivot
  (Qty for indicator in (
			...
			IF @isFill_All_Tables = 1
			BEGIN
				--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_KD_Monthly_Common
				DELETE T FROM tmp.TMP_Report_verification_fedor_KD_Monthly_Common AS T WHERE T.ProcessGUID = @ProcessGUID

				INSERT tmp.TMP_Report_verification_fedor_KD_Monthly_Common
				SELECT
					ProcessGUID = @ProcessGUID,
					i.num_rows 
					--num_rows = replace(convert(varchar(10), i.num_rows), '.0','')
					...
					,Qty_dist=null
					,Tm_Qty =null--isnull(Tm_Qty,0.00)
				--INTO tmp.TMP_Report_verification_fedor_KD_Monthly_Common
...
select d.* 
 ...
 , [Общее кол-во заведенных заявок Call2]                                        = cast(format(call2.Qty,'0') as nvarchar(50))
       , [Кол-во автоматических отказов Call2]                                         = cast(format(call2.Qty_rejected,'0') as nvarchar(50))
       , [%  автоматических отказов Call2]                                             = cast(format(case when call2.Qty<>0 then 100.0*call2.Qty_rejected/call2.Qty else 0 end,'0.0')+N'%' as nvarchar(50))
       , [TTY  - % заявок рассмотренных в течение 21 минут на этапе Вериф.клиента]     = cast(format(case when  [Общее кол-во заявок на этапе Вериф.клиента]<>0 then 100.0*tty.cnt/ [Общее кол-во заявок на этапе Вериф.клиента] else 0 end,'0') as nvarchar(50))
...
from (
  select Дата=cast(format(Дата,'yyyyMM01') as date)
       ...
       , [Средний Processing time на этапе (время обработки заявки) Вериф.ТС]          = case when sum(КоличествоЗаявок)<>0 then cast(isnull(convert(nvarchar,cast((sum(ВремяЗатрачено)/sum(КоличествоЗаявок)) as datetime),8)  ,0) as nvarchar(50))
                                                                                          else '0' end
       , [Кол-во одобренных заявок после этапа Вериф.ТС]                               = cast(format(sum(Одобрено),'0')as nvarchar(50))
       , [Кол-во отказов со стороны сотрудников Вериф.ТС]                              = cast(format(sum([Отказано]),'0')as nvarchar(50)) 
 ...
 LEFT JOIN #НеВернувшиесяИзОтложенных_ts AS u2 on u2.[Дата статуса] = d.Дата
  ...
  select Дата, indicator, Qty 
    ...
    select v.Дата
		...
		, v.[Не определен ВК]
         , v.[Общее кол-во заявок на этапе Вериф.клиента]                             
         , v.[TTY  - % заявок рассмотренных в течение 21 минут на этапе Вериф.клиента]
		...
		, t.[Не определен ВТС]
         ...
         , t.[TTY  - количество заявок рассмотренных в течение 30 минут на этапах КД, ВК, ВТС]
         , t.[TTY  - % заявок рассмотренных в течение 30 минут на этапах КД,ВК,ВТС]
...
unpivot
  (Qty for indicator in (
		...
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_V_Monthly_Common
			DELETE T FROM tmp.TMP_Report_verification_fedor_V_Monthly_Common AS T WHERE T.ProcessGUID = @ProcessGUID

			INSERT tmp.TMP_Report_verification_fedor_V_Monthly_Common
			SELECT
				ProcessGUID = @ProcessGUID,
				i.num_rows 
				--num_rows = replace(convert(varchar(10), i.num_rows), '.0','')
				...
				, [Сумма] =null
				  ...
				  , Qty_dist=null
				  , Tm_Qty =null--isnull(Tm_Qty,0.00)
			--INTO tmp.TMP_Report_verification_fedor_V_Monthly_Common
...
begin
	drop table if exists #indicator_for_PD
	create table #indicator_for_PD(
			[num_rows] numeric(6,2) NULL --int null 
		, [name_indicator] nvarchar(250) null
	)
	insert into #indicator_for_PD([num_rows] ,[name_indicator])
	values
	--  (1 ,'Общее кол-во заведенных заявок')
	--, (2 ,'Кол-во автоматических отказов Логином')
	--, (3 ,'%  автоматических отказов Логином')
	...
	IF @Page = 'PD.HoursGroupDaysUnique' OR @isFill_All_Tables = 1 --241
	BEGIN
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PD_HoursGroupDaysUnique
			DELETE T FROM tmp.TMP_Report_verification_fedor_PD_HoursGroupDaysUnique AS T WHERE T.ProcessGUID = @ProcessGUID
			...
			INSERT tmp.TMP_Report_verification_fedor_PD_HoursGroupDaysUnique
			SELECT
				ProcessGUID = @ProcessGUID,
				isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
			--INTO tmp.TMP_Report_verification_fedor_PD_HoursGroupDaysUnique
			from (select distinct Интервал, cast(Дата as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
				...
				on mm.Интервал = hd.Интервал and mm.дата = hd.Дата

				INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
				SELECT getdate(), 'PD.HoursGroupDaysUnique', @ProcessGUID
			END
		ELSE BEGIN
	...
	IF @Page = 'PD.HoursGroupDays' OR @isFill_All_Tables = 1 --241
	BEGIN
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PD_HoursGroupDays
			DELETE T FROM tmp.TMP_Report_verification_fedor_PD_HoursGroupDays AS T WHERE T.ProcessGUID = @ProcessGUID
			...
			INSERT tmp.TMP_Report_verification_fedor_PD_HoursGroupDays
			SELECT
				ProcessGUID = @ProcessGUID,
				isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
			--INTO tmp.TMP_Report_verification_fedor_PD_HoursGroupDays
			FROM (select distinct Интервал, cast(Дата as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
			...
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PD.HoursGroupDays', @ProcessGUID
		END
		ELSE BEGIN
			;with c2 as (
				select null as [ФИО сотрудника верификации/чекер]
	...
	IF @Page = 'PD.HoursGroupMonthUnique' OR @isFill_All_Tables = 1 --241
	BEGIN
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PD_HoursGroupMonthUnique
			DELETE T FROM tmp.TMP_Report_verification_fedor_PD_HoursGroupMonthUnique AS T WHERE T.ProcessGUID = @ProcessGUID
			...
			INSERT tmp.TMP_Report_verification_fedor_PD_HoursGroupMonthUnique
			SELECT
				ProcessGUID = @ProcessGUID,
				isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, hd.ИнтервалСтрока
			--INTO tmp.TMP_Report_verification_fedor_PD_HoursGroupMonthUnique
			FROM (select distinct Интервал, cast(format(Дата,'yyyyMM01') as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
			...
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PD.HoursGroupMonthUnique', @ProcessGUID
		END
		ELSE BEGIN
			;with c2 as (
				select null as [ФИО сотрудника верификации/чекер]
    ...
    -- Лист "ПД. Общее количество по часам"
	IF @Page = 'PD.HoursGroupMonth' OR @isFill_All_Tables = 1 --241
	BEGIN
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PD_HoursGroupMonth
			DELETE T FROM tmp.TMP_Report_verification_fedor_PD_HoursGroupMonth AS T WHERE T.ProcessGUID = @ProcessGUID
			...
			INSERT tmp.TMP_Report_verification_fedor_PD_HoursGroupMonth
			SELECT
				ProcessGUID = @ProcessGUID,
				isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
			--INTO tmp.TMP_Report_verification_fedor_PD_HoursGroupMonth
			FROM (select distinct Интервал, cast(format(Дата,'yyyyMM01') as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
			...
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PD.HoursGroupMonth', @ProcessGUID
		END
		ELSE BEGIN
			;with c2 as (
				select null as [ФИО сотрудника верификации/чекер]
   ...
   END
	...
	IF @Page = 'PD.Daily.Common' OR @isFill_All_Tables = 1
	BEGIN

		DROP table if exists #waitTime_PD
		...
		;with r AS (
			...
			from #t_dm_FedorVerificationRequests r
			where [Состояние заявки]='Ожидание' 
				AND r.Статус='Подтверждение дохода' 
				AND NOT (
					r.Задача='task:Новая'
					AND r.[Задача следующая] = 'task:Автоматически отложено'
				)
				--AND [Дата статуса]>= @dt_from and  [Дата статуса]<@dt_to 
				AND 
					(Работник in (select e.Employee from #PDEmployees e)
					-- для учета, когда ожидание назначено на сотрудника
					OR Назначен in (select e.Employee from #PDEmployees e)
					)
		)
		select [Дата статуса]=cast([Дата статуса] as date) 
			--  , [Номер заявки]
		...
		--	, count(distinct [Номер заявки]) cnt
		--into #verif_KC
		--from #t_dm_FedorVerificationRequests r where [Дата статуса]>= @dt_from and  [Дата статуса]<@dt_to
		--	and  Статус='Верификация КЦ' and [Статус следующий]='Отказано'
		--group by cast([Дата статуса] as date) 
 

		-- считаем уникальных отложенных по ПД
        drop table if exists #ReportByEmployeeAgg_PD_UniquePostone
        ...
        select c1.*              
        into #ReportByEmployeeAgg_PD_UniquePostone
        from c1 
            

		-- посчитаем количество уникальных отложенных ПД теперь и по дням
		drop table if exists #postpone_unique_PD_daily
 
		select 
			[Дата статуса]=cast(([Дата]) as date),
			sum(p.ОтложенаУникальныеKD) ОтложенаУникальныеKD 
		into #postpone_unique_PD_daily
		from #ReportByEmployeeAgg_PD_UniquePostone p
		group by cast(([Дата]) as date)

  
		drop table if exists #all_requests_PD
  
		select [Дата заведения заявки] 
			, count(distinct [Номер заявки]) Qty
		into #all_requests_PD
		from #t_dm_FedorVerificationRequests
			join #calendar c on c.dt_day=[Дата заведения заявки]
		where 1=1
			and [Дата статуса]>=@dt_from and  [Дата статуса]<@dt_to
		...
		--select * from #all_requests_PD
		-- TTY
		--IF @isDebug = 1 BEGIN
		--	DROP TABLE IF EXISTS ##all_requests_PD
		--	SELECT * INTO ##all_requests_PD FROM #all_requests_PD

		--	DROP TABLE IF EXISTS ##calendar
		--	SELECT * INTO ##calendar FROM #calendar
		--END
   
		drop table if exists #tty_PD
		...
		select Дата
			...
			, case when cast(cast(ВремяЗатрачено as datetime) as time)>'00:06:00' then '-' else 'tty' end tty_flag
		into #tty_PD
		from #fedor_verificator_report_PD where status='task:В работе'
		...
		from (
			...
			join #all_requests_PD r on r.[Дата заведения заявки] = d.Дата
			left join #waitTime_PD w on w.[Дата статуса]=d.Дата
			left join #postpone_unique_PD_daily u on u.[Дата статуса] = d.Дата
			left join (
				select дата
					, count([Номер заявки]) cnt
				-- , ВремяЗатрачено 
		...
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PD_Daily_Common
			DELETE T FROM tmp.TMP_Report_verification_fedor_PD_Daily_Common AS T WHERE T.ProcessGUID = @ProcessGUID

			INSERT tmp.TMP_Report_verification_fedor_PD_Daily_Common
			SELECT
				ProcessGUID = @ProcessGUID,
				i.num_rows 
				--num_rows = replace(convert(varchar(10), i.num_rows), '.0','')
				...
				, Qty_dist=null
				, Tm_Qty =null--isnull(Tm_Qty,0.00)
				--INTO tmp.TMP_Report_verification_fedor_PD_Daily_Common
			from #unp_PD u 
				join #indicator_for_PD i on u.indicator=i.name_indicator
			--ORDER BY i.num_rows

			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PD.Daily.Common', @ProcessGUID
		END
		ELSE BEGIN
			SELECT
				i.num_rows 
	...
	IF @Page= 'PD.Monthly.Common' OR @isFill_All_Tables = 1
	BEGIN
		--drop table if exists #verif_KC_m
		...
		drop table if exists #waitTime_PD_m
		...
		;with r as (
			...
			where [Состояние заявки]='Ожидание'
				...
				--AND [Дата статуса]>= @dt_from and  [Дата статуса]<@dt_to
				and (Работник in (select e.Employee from #PDEmployees e)
					or Назначен in (select e.Employee from #PDEmployees e)
				)
		)
		select [Дата статуса]=cast(format([Дата статуса],'yyyyMM01') as date) 
		...
		drop table if exists #all_requests_PD_m
  
		select [Дата заведения заявки] =format([Дата заведения заявки] ,'yyyyMM01')
			, count(distinct [Номер заявки]) Qty 
		into #all_requests_PD_m
		from #t_dm_FedorVerificationRequests
			join #calendar c on c.dt_day=[Дата заведения заявки]
		where 1=1
			and [Дата статуса]>=@dt_from and  [Дата статуса]<@dt_to
		...
		IF @isDebug = 1 BEGIN
			DROP TABLE IF EXISTS ##all_requests_PD_m
			SELECT * INTO ##all_requests_PD_m FROM #all_requests_PD_m
		...
		-- посчитаем количество уникальных отложенных КД
		-- считаем уникальных отложенных по КД
        drop table if exists #ReportByEmployeeAgg_PD_UniquePostone_m
		...
		select c1.*              
		into #ReportByEmployeeAgg_PD_UniquePostone_m
		from c1 

		drop table if exists #postpone_unique_PD_m
		select 
			[Дата статуса]=cast(format([Дата],'yyyyMM01') as date),
			sum(p.ОтложенаУникальныеKD) ОтложенаУникальныеKD 
		into #postpone_unique_PD_m
		from #ReportByEmployeeAgg_PD_UniquePostone_m p
		group by cast(format(Дата,'yyyyMM01') as date)


		drop table if exists #PD_m
		...
		join #all_requests_PD_m r on r.[Дата заведения заявки]=d.Дата
		left join #waitTime_PD_m w on w.[Дата статуса]=d.Дата
		left join #postpone_unique_PD_m u on u.[Дата статуса] = d.Дата
		left join (
			select дата=cast(format(Дата,'yyyyMM01') as date)
				, count([Номер заявки]) cnt
				-- , ВремяЗатрачено 
		...
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PD_Monthly_Common
			DELETE T FROM tmp.TMP_Report_verification_fedor_PD_Monthly_Common AS T WHERE T.ProcessGUID = @ProcessGUID

			INSERT tmp.TMP_Report_verification_fedor_PD_Monthly_Common
			SELECT
				ProcessGUID = @ProcessGUID,
				i.num_rows 
				--num_rows = replace(convert(varchar(10), i.num_rows), '.0','')
				...
				,Qty_dist=null
				,Tm_Qty =null--isnull(Tm_Qty,0.00)
			--INTO tmp.TMP_Report_verification_fedor_PD_Monthly_Common
			FROM #unp_PD_m u join #indicator_for_PD i on u.indicator=i.name_indicator
			--ORDER BY i.num_rows

			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PD.Monthly.Common', @ProcessGUID
		END
		ELSE BEGIN
			SELECT 
				i.num_rows 
...
begin
	...
	IF @Page = 'PSV.HoursGroupDaysUnique' OR @isFill_All_Tables = 1 --241
	BEGIN
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PSV_HoursGroupDaysUnique
			DELETE T FROM tmp.TMP_Report_verification_fedor_PSV_HoursGroupDaysUnique AS T WHERE T.ProcessGUID = @ProcessGUID
			...
			INSERT tmp.TMP_Report_verification_fedor_PSV_HoursGroupDaysUnique
			SELECT
				ProcessGUID = @ProcessGUID,
				isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
			--INTO tmp.TMP_Report_verification_fedor_PSV_HoursGroupDaysUnique
			from (select distinct Интервал, cast(Дата as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
				...
				INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
				SELECT getdate(), 'PSV.HoursGroupDaysUnique', @ProcessGUID
			END
		ELSE BEGIN
	...
	IF @Page = 'PSV.HoursGroupDays' OR @isFill_All_Tables = 1 --241
	BEGIN
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PSV_HoursGroupDays
			DELETE T FROM tmp.TMP_Report_verification_fedor_PSV_HoursGroupDays AS T WHERE T.ProcessGUID = @ProcessGUID
			...
			INSERT tmp.TMP_Report_verification_fedor_PSV_HoursGroupDays
			SELECT
				ProcessGUID = @ProcessGUID,
				isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
			--INTO tmp.TMP_Report_verification_fedor_PSV_HoursGroupDays
			FROM (select distinct Интервал, cast(Дата as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
			...
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PSV.HoursGroupDays', @ProcessGUID
		END
		ELSE BEGIN
			;with c2 as (
				select null as [ФИО сотрудника верификации/чекер]
	...
	IF @Page = 'PSV.HoursGroupMonthUnique' OR @isFill_All_Tables = 1 --241
	BEGIN
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonthUnique
			DELETE T FROM tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonthUnique AS T WHERE T.ProcessGUID = @ProcessGUID
			...
			INSERT tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonthUnique
			SELECT
				ProcessGUID = @ProcessGUID,
				isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, hd.ИнтервалСтрока
			--INTO tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonthUnique
			FROM (select distinct Интервал, cast(format(Дата,'yyyyMM01') as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
			...
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PSV.HoursGroupMonthUnique', @ProcessGUID
		END
		ELSE BEGIN
			;with c2 as (
				select null as [ФИО сотрудника верификации/чекер]
    ...
    -- Лист "ПД. Общее количество по часам"
	IF @Page = 'PSV.HoursGroupMonth' OR @isFill_All_Tables = 1 --241
	BEGIN
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonth
			DELETE T FROM tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonth AS T WHERE T.ProcessGUID = @ProcessGUID
			...
			INSERT tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonth
			SELECT
				ProcessGUID = @ProcessGUID,
				isnull(КоличествоЗаявок,0) КоличествоЗаявок , hd.Интервал, hd.Дата, ИнтервалСтрока
			--INTO tmp.TMP_Report_verification_fedor_PSV_HoursGroupMonth
			FROM (select distinct Интервал, cast(format(Дата,'yyyyMM01') as date) Дата, ИнтервалСтрока from #HoursDays)  hd
				LEFT join (
					select c2.Интервал
						, дата
			...
			INSERT LogDb.dbo.Fill_Report_verification_fedor(StartDateTime, ReportPage, ProcessGUID)
			SELECT getdate(), 'PSV.HoursGroupMonth', @ProcessGUID
		END
		ELSE BEGIN
			;with c2 as (
				select null as [ФИО сотрудника верификации/чекер]
   ...
   END
	...
	BEGIN
		...
		from (
			...
			join #all_requests_PSV r on r.[Дата заведения заявки] = d.Дата
			left join #waitTime_PSV w on w.[Дата статуса]=d.Дата
			left join #postpone_unique_PSV_daily u on u.[Дата статуса] = d.Дата
			left join (
				select дата
					, count([Номер заявки]) cnt
				-- , ВремяЗатрачено 
		...
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PSV_Daily_Common
			DELETE T FROM tmp.TMP_Report_verification_fedor_PSV_Daily_Common AS T WHERE T.ProcessGUID = @ProcessGUID

			INSERT tmp.TMP_Report_verification_fedor_PSV_Daily_Common
			SELECT
				ProcessGUID = @ProcessGUID,
				i.num_rows 
				--num_rows = replace(convert(varchar(10), i.num_rows), '.0','')
				...
				, Qty_dist=null
				, Tm_Qty =null--isnull(Tm_Qty,0.00)
				--INTO tmp.TMP_Report_verification_fedor_PSV_Daily_Common
			from #unp_PSV u 
	...
	BEGIN
		...
		join #all_requests_PSV_m r on r.[Дата заведения заявки]=d.Дата
		left join #waitTime_PSV_m w on w.[Дата статуса]=d.Дата
		left join #postpone_unique_PSV_m u on u.[Дата статуса] = d.Дата
		left join (
			select дата=cast(format(Дата,'yyyyMM01') as date)
				, count([Номер заявки]) cnt
				-- , ВремяЗатрачено 
		...
		IF @isFill_All_Tables = 1
		BEGIN
			--DROP TABLE IF EXISTS tmp.TMP_Report_verification_fedor_PSV_Monthly_Common
			DELETE T FROM tmp.TMP_Report_verification_fedor_PSV_Monthly_Common AS T WHERE T.ProcessGUID = @ProcessGUID

			INSERT tmp.TMP_Report_verification_fedor_PSV_Monthly_Common
			SELECT
				ProcessGUID = @ProcessGUID,
				i.num_rows 
				--num_rows = replace(convert(varchar(10), i.num_rows), '.0','')
				...
				,Qty_dist=null
				,Tm_Qty =null--isnull(Tm_Qty,0.00)
			--INTO tmp.TMP_Report_verification_fedor_PSV_Monthly_Common
