...
CREATE  PROCEDURE  [dbo].[report_Collection_Commumication_Update_DM]
...
BEGIN
  ...
  delete from dbo.dm_report_Collection_Commumication where CommunicationDate>=dateadd(day,-3,cast(getdate() as date))
  insert into dbo.dm_report_Collection_Commumication
  select * 
  ...
  --drop table if exists dbo.report_Colection_CustomerHistoryStage
  --DWH-1764 
  TRUNCATE TABLE dbo.report_Colection_CustomerHistoryStage
INSERT dbo.report_Colection_CustomerHistoryStage
(
    ObjectId,
    ChangeDate,
    ChangeDate_old,
...
SELECT [ObjectId]
	  ...
	  --into dbo.report_Colection_CustomerHistoryStage
 ...
 delete from dbo.report_Colection_CustomerHistoryStage where rn>1
