...
-- =============================================
/*
EXEC Reports.service.Report_dashboard_BKI_NEW
	@Page = 'Detail'
	,@dtFrom = '2024-11-01'
	,@dtTo = '2024-12-10'

*/
CREATE PROC service.Report_dashboard_BKI_NEW
...
BEGIN TRY
	...
	IF @Page = 'Parameters' BEGIN
		...
		select max_update_at = @max_update_at
	...
	IF @isDebug = 1 BEGIN
		DROP TABLE IF EXISTS ##t_Detail_NEW
		SELECT * INTO ##t_Detail_NEW FROM #t_Detail
	END
	...
	IF @isDebug = 1 BEGIN
		...
		--DROP TABLE IF EXISTS Reports.tmp.TMP_AND_ErrorDetail_NEW

		SELECT top 20000 D.*
		INTO ##t_ErrorDetail
		--INTO Reports.tmp.TMP_AND_ErrorDetail_NEW
		FROM #t_Detail AS D
		WHERE D.isError = 1
	END
	...
	IF @isDebug = 1 BEGIN
		DROP TABLE IF EXISTS ##t_Statistics_NEW
		SELECT * INTO ##t_Statistics_NEW FROM #t_Statistics
	END
	...
	IF @isDebug = 1 BEGIN
		DROP TABLE IF EXISTS ##t_Statistics2_NEW
		SELECT * INTO ##t_Statistics2_NEW FROM #t_Statistics2
	END
