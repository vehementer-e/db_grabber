...
begin
	...
	EXEC dbo.SendToSlack_dwhNotification  @text
	exec dbo.[LogAndSendMailToAdmin] 'trying CheckExists_dm_CMRStatBalance','Info','procedure started',N''
BEGIN try
	...
	exec dbo.[LogAndSendMailToAdmin] 'Проверка витрины dm_CMRStatBalance завершена','Info','procedure finished',N''
end try
begin catch
	...
	EXEC  [LogDb].dbo.SendToSlack_dwhNotification  @text
	EXEC dbo.[LogAndSendMailToAdmin] 'Данные витрины dm_CMRStatBalance не актуальны','Error','Error',@error_description
