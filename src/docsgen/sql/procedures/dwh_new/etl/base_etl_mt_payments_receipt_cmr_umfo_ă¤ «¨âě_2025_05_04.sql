...
-- =============================================
CREATE PROCEDURE [etl].[base_etl_mt_payments_receipt_cmr_umfo]
...
into #BusinessLoan_UMFO
  ...
  --[C2-VSR-SQL04].[umfo].[dbo].[Документ_АЭ_ЗаймПредоставленный] dd  with (nolock) --y
    --left join [C2-VSR-SQL04].[umfo].[dbo].[Справочник_АЭ_ФинансовыеПродукты] fp  
