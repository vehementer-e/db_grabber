...
CREATE PROCEDURE [dbo].[additional]
...
FROM       OPENXML (@idoc, '/bki_response/response/add_part/attrs/package/section/period/attr',1)
with (c_i nvarchar(30),
n int,v nvarchar(max))
