...
CREATE PROCEDURE [finAnalytics].[calcRep840FirstLevel_4_v1]
	@repmonth date,
    @repdate date
...
exec finAnalytics.calcRep840FirstLevel_4sub_v1  @dataLevel, @prosCategory, @repmonth,@repdate,@rowNum,@rowName,@rowPokazatel
