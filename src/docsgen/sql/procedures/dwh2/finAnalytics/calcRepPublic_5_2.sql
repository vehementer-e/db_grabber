...
CREATE PROC [finAnalytics].[calcRepPublic_5_2] 
    @repmonth date
AS
BEGIN
    ...
    begin try
		...
		from dwh2.[finAnalytics].[SPR_repPublicPL_5_2] a
		...
		delete from dwh2.[finAnalytics].[repPublicPL_5_2] where repmonth = @repmonth

		insert into dwh2.[finAnalytics].[repPublicPL_5_2]
