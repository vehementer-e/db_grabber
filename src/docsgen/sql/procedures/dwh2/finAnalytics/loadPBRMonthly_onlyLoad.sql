...
CREATE   PROCEDURE [finAnalytics].[loadPBRMonthly_onlyLoad] 
...
BEGIN
   ...
   begin try
	...
	--exec finAnalytics.checkZaim 'monthly', @repmonth
	
	---- проверка "Наличие залога поручительства"
	--exec finAnalytics.checkPTSAutocredit @repmonth
	...
	--exec [finAnalytics].[loadPBR_PDNCheck] @repmonth, 'monthly'
