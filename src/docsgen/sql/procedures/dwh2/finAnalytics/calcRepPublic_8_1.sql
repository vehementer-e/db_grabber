...
CREATE PROC [finAnalytics].[calcRepPublic_8_1] 
    @repmonth date
AS
BEGIN
    ...
    begin try
		...
		, [sumAmountItog] = 0
		from dwh2.[finAnalytics].[SPR_repPublicPL_8_1] a
		...
		delete from dwh2.[finAnalytics].[repPublicPL_8_1] where repmonth = @repmonth

		insert into dwh2.[finAnalytics].[repPublicPL_8_1]
