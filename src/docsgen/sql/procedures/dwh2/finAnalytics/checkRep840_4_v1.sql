...
CREATE PROCEDURE [finAnalytics].[checkRep840_4_v1]
	@repMonth date,
    @repDate date,
...
--3
,[Алгоритм проверки колонка 3] = 'Берем из отчета "ПБР" строки, где "Признак заемщика" равен "ФЛ", "Сумма займа" меньше или равна 30 000 руб., "Срок договора в днях" меньше или равен 30 и "Реструктурирован" равно "нет". '
...
,[Данные УМФО колонка 3] = (
                    ...
                    from #PBR
                    where isZaemshik='ФЛ'
                      and (dogSum<=30000 and dogPeriodDays <=30)
                      and upper(isRestruk) = upper('Нет')
                )
--4
,[Алгоритм проверки колонка 4] = 'Берем из отчета "ПБР" строки, где "Признак заемщика" равен "ФЛ", "Сумма займа" больше 30 000 руб. ИЛИ ("Сумма займа" меньше или равно 30 000 руб. И "Срок договора в днях" больше 30), "Реструктурирован" равно "нет", "Обеспеченный займ" равно "Да". '
...
--6
,[Алгоритм проверки колонка 6] = 'Берем из отчета "ПБР" строки, где "Признак заемщика" равен "ФЛ", "Сумма займа" больше 30 000 руб. ИЛИ ("Сумма займа" меньше или равно 30 000 руб. И "Срок договора в днях" больше 30), "Реструктурирован" равно "нет", "Обеспеченный займ" равно "Нет". '
...
--8
,[Алгоритм проверки колонка 8] = 'Берем из отчета "ПБР" строки, где "Признак заемщика" не равен "ФЛ", "МСП" равен "Да", "Реструктурирован" равно "нет", "Обеспеченный займ" равно "Да". '
...
,[Данные УМФО колонка 8] = (
                    ...
                    from #PBR
                    where isZaemshik!='ФЛ'
                      and upper(isMSPbyRepDate) = upper('Да')
                      and upper(isRestruk) = upper('Нет')
                      and upper(isObespechZaym) = upper('Да')
                )

--10
,[Алгоритм проверки колонка 10] = 'Берем из отчета "ПБР" строки, где "Признак заемщика" не равен "ФЛ", "МСП" равен "Да", "Реструктурирован" равно "нет", "Обеспеченный займ" равно "Нет". '
...
--11
,[Алгоритм проверки колонка 11] = 'Берем из отчета "ПБР" строки, где "Признак заемщика" не равен "ФЛ", "МСП" равен "Нет", "Реструктурирован" равно "нет", "Обеспеченный займ" равно "Да". '
...
--13
,[Алгоритм проверки колонка 13] = 'Берем из отчета "ПБР" строки, где "Признак заемщика" не равен "ФЛ", "МСП" равен "Нет", "Реструктурирован" равно "нет", "Обеспеченный займ" равно "Нет". '
...
--14
,[Алгоритм проверки колонка 14] = 'Берем из отчета "ПБР" строки, где "Признак заемщика" равен "ФЛ", "Сумма займа" меньше или равна 30 000 руб., "Срок договора в днях" меньше или равен 30 и "Реструктурирован" равно "да". '
...
--15
,[Алгоритм проверки колонка 15] = 'Берем из отчета "ПБР" строки, где, если "Признак заемщика" равен "ФЛ", то "Сумма займа" больше 30 000 руб. ИЛИ ("Сумма займа" меньше или равно 30 000 руб. И "Срок договора в днях" больше 30), и "Реструктурирован" равно "да", "Обеспеченный займ" равно "Да", либо строки, где, если "Признак заемщика" не равен "ФЛ", "Реструктурирован" равно "да", "Обеспеченный займ" равно "Да"'
...
--17
,[Алгоритм проверки колонка 17] = 'Берем из отчета "ПБР" строки, где, если "Признак заемщика" равен "ФЛ", то "Сумма займа" больше 30 000 руб. ИЛИ ("Сумма займа" меньше или равно 30 000 руб. И "Срок договора в днях" больше 30), и "Реструктурирован" равно "да", "Обеспеченный займ" равно "Нет", либо строки, где, если "Признак заемщика" не равен "ФЛ", "Реструктурирован" равно "да", "Обеспеченный займ" равно "Нет"'
