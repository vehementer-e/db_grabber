...
/*
EXEC etl.[GetDeactivatedMarketProposal_povtInst_RMQ_JSON]
	@env = 'prod',
...
-- =======================================================
CREATE       PROC [etl].[GetDeactivatedMarketProposal_povtInst_RMQ_JSON]
...
begin
	...
	--	and m.marketProposal_ID = '1E0267AB-323B-F84B-974D-1A4E65DEFD76'
