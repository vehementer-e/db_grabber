 ...
 -- [etl].[Send_MarketingProposal2RMQ_docredyPts] @env = 'prod', @CMRClientGUID = 'C6DCA609-08F9-11E8-A814-00155D941900'
CREATE      procedure [etl].[Send_MarketingProposal2RMQ_docredyPts]
...
begin
	...
	exec logdb.dbo.[LogAndSendMailToAdmin] 
		'trying start [etl].[Send_MarketingProposal2RMQ_docredyPts]','Info',' started', ''
	...
	begin catch
		...
		exec logdb.dbo.[LogAndSendMailToAdmin] 'catching error [etl].[Send_MarketingProposal2RMQ_docredyPts]','Error','Error',@error_description
