 ...
 -- [etl].[Send_MarketingProposal2RMQ_povtPdl] @env = 'prod', @CMRClientGUID = '8391211A-0901-11E8-A814-00155D941900'
CREATE      procedure [etl].[Send_MarketingProposal2RMQ_povtPdl]
