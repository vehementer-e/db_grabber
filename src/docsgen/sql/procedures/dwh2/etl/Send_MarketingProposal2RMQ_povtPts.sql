 ...
 -- [etl].[Send_MarketingProposal2RMQ_povtPts] @env = 'prod', @CMRClientGUID = 'C6DCA609-08F9-11E8-A814-00155D941900'
CREATE      procedure [etl].[Send_MarketingProposal2RMQ_povtPts]
...
begin
	...
	exec logdb.dbo.[LogAndSendMailToAdmin] 
		'trying start [etl].[Send_MarketingProposal2RMQ_povtPts]','Info',' started', ''
	...
	begin try
		...
		exec CommonDb.dbo.[RequestHttpWebService]
			...
			begin
				...
				exec logdb.dbo.[LogAndSendMailToAdmin] 'exec [etl].[Send_MarketingProposal2RMQ_povtPts]','Info','Done',''
			end
	...
	begin catch
       ...
       set @text=CONCAT_WS(' ', 
		...
		exec logdb.dbo.[LogAndSendMailToAdmin] 'catching error [etl].[Send_MarketingProposal2RMQ_povtPts]','Error','Error',@error_description
