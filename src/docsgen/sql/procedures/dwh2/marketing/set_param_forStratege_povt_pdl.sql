...
CREATE       procedure [marketing].[set_param_forStratege_povt_pdl]
...
begin try
	...
	and lower(t.market_proposal_category_code) in ('green')
	...
	begin tran
		...
		update t
			...
			case when t.has_pts_market_proposal  = 1
				...
				when [has_inst_market_proposal] = 1 
					then 'has_inst_market_proposal'
				when t.phoneInBlackList = 1 
					then 'UNKNOWN'
