CREATE   procedure [marketing].[set_lastNaumenResult_povt_inst]
as
begin
--Сбор данных по результатам последнего звонка по маркетинговым предложениям повторники инстолмент
	...
	and exists(select top(1) 1 from  #povInstClientPhone cp 
	...
	on cp.client_number = RIGHT(os.client_number , 10) 
