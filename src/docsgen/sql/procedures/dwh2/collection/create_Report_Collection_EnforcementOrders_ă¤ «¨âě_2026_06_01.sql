...
-- Description:	DWH-2305 Реверс инжиниринг отчета Коллекшн. ИП
-- =============================================
CREATE  PROC [collection].[create_Report_Collection_EnforcementOrders]
as
begin
begin TRY
	SET XACT_ABORT ON;
	...
	*/
	...
	SELECT 
		...
		T.Сумма_по_ИЛ 
	FROM #t_EnforcementOrders AS T
	ORDER BY T.Конец_месяца
