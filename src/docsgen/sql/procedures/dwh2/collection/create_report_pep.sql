...
CREATE PROC [collection].[create_report_pep]
as
begin
...
group by idcustomer
 ...
 delete from  [collection].report_pep_details--Analytics.dbo.report_pep_details
 insert into  [collection].report_pep_details-- Analytics.dbo.report_pep_details
...
from #DialerClientContractStage a
  left join [collection].[report_pep_details] b on a.[idCustomer]=b.idcustomer
  ...
  delete from [collection].report_collection_stages_by_customers_history--Analytics.dbo.report_collection_stages_by_customers_history
  insert into [collection].report_collection_stages_by_customers_history--Analytics.dbo.report_collection_stages_by_customers_history
  select * from #t
 ...
 drop table if exists #t2
  ...
  from  [collection].report_collection_stages_by_customers_history
  group by StageDate, StageName

  delete from [collection].report_collection_stages_by_customers_history_agr-- Analytics.dbo.report_collection_stages_by_customers_history_agr 
  insert into [collection].report_collection_stages_by_customers_history_agr-- Analytics.dbo.report_collection_stages_by_customers_history_agr 
  select *  from #t2
 ...
 --select * into  Analytics.dbo.report_collection_stages_by_customers_history_agr from #t2
  ...
  outer apply (select top 1 * from [collection].report_pep_details where report_pep_details.sms_id_uv=sms.sms_id) x
  left join [collection].report_collection_stages_by_customers_history ch on ch.idCustomer=sms.CustomerId and cast(sms.sms_datetime as date)=ch.StageDate
   
   
   --drop table if exists  Analytics.dbo.report_pep_sms_details
   delete from [collection].report_pep_sms_details--Analytics.dbo.report_pep_sms_details
   insert into [collection].report_pep_sms_details-- Analytics.dbo.report_pep_sms_details
   select *   from #t3
