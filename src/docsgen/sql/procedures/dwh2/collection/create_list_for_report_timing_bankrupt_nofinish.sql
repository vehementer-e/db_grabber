 ...
 CREATE PROCEDURE [collection].[create_list_for_report_timing_bankrupt_nofinish] 
...
begin transaction 
    ...
    delete from [collection].[list_for_report_timing_bankrupt_nofinish];
	insert [collection].[list_for_report_timing_bankrupt_nofinish] 
...
where 1 = 1
		...
		and [NewValue] = 'True'
		and cb.[BankruptcyFinishDate] is null
