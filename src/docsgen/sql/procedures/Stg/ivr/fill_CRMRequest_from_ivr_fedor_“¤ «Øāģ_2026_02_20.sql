...
-- EXEC ivr.fill_CRMRequest_from_ivr_fedor @param1 = <value>, @param2 = <value>;
-- Список и типы параметров смотрите в объявлении процедуры ниже.
CREATE   PROC ivr.fill_CRMRequest_from_ivr_fedor
...
begin try
	...
	*/
	...
	EXEC [DWH-EX].Dialer.dbo.ImportIVRFromDWH_byRequest
