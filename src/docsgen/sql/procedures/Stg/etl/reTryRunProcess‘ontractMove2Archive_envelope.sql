...
--перезапуск заданий на по contractMove2Archive за сегодня
/*
...
-- EXEC [etl].[reTryRunProcessСontractMove2Archive_envelope]
--      @processGUID = null,
--      @whaitCompleted = 1,
--      @timeOut = 40,
--      @reTryCount = 10;
...
begin
	...
	begin try
		...
		where ProcessType in('contractMove2Archive')
			and StatusCode IN ('Error', 'New')
