...
CREATE procedure [dbo].[prc$update_rep_coll_weekly_part1_2] 
...
declare @vinfo varchar(1000) = concat('START rep_dt = ', format(@rdt, 'dd.MM.yyyy'),
	...
	drop table if exists ##CMR_weekly; --#CMR;
	...
	drop index if exists tmp_cmr_idx on ##CMR_weekly; --#CMR;
	create clustered index tmp_cmr_idx on ##CMR_weekly (external_id, r_date); --#CMR (external_id, r_date);
	...
	and exists (select 1 from ##CMR_weekly e 
...
--drop table if exists #weekly_recov_MAR20;
--select * into #weekly_recov_MAR20 from dbo.rep_coll_weekly_recov
--where seg_high = 'MAR20'
...
--insert into dbo.rep_coll_weekly_recov
--select * from #weekly_recov_MAR20;
...
exec RiskDWH.dbo.prc$set_debug_info @src = @src_name, @info = 'rep_coll_weekly_0_90_hard';
	...
	/*drop table if exists #0_90_hard_MAR20;
	select * 
	into #0_90_hard_MAR20
	from RiskDWH.dbo.rep_coll_weekly_0_90_hard
	where seg_high = 'MAR20';*/
