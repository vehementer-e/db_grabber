...
create   proc  [_tg].[AnalyticsBot_backup_20231019]
...
where cast([Заем выдан]   as date ) between '20180101' and getdate()
...
select 'Телеком'            channel, 9 channel_order_num, product = 'ПТС' union all
select 'Всего'            channel, 10 channel_order_num, product = 'ПТС' union all
...
select 'Всего'            channel, 10 channel_order_num, product = 'Инстоллмент' union all
select 'Всего'            channel, 10 channel_order_num, product = null --union all
