--select datediff(day, '20250301', getdate())
--sale_report_ttc_case 275
CREATE      PROC-- exec
 sale_report_ttc_case
@number_of_days_updated int = 3	,
@debug int = 0

as 
 
 --sp_create_job 'Analytics._sale_report_ttc_case 83000', 'sale_report_ttc_case', '1', '83000'
