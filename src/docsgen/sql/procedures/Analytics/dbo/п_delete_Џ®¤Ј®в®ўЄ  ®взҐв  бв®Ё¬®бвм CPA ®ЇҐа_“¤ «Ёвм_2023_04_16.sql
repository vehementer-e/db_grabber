CREATE   PROC [dbo].[Подготовка отчета стоимость CPA опер_Удалить_2023_04_16]
as
begin
...
when UF_SOURCE in ('mastertarget' ) then 
											case 
												...
												when ДеньЗаявки >='20221101' and isInstallment=0 and ЗаявкаAPI_или_API2=1 then
											  ...
											  when ДеньЗайма>='20221101' and isInstallment=0 and  ЗаявкаAPI_или_API2=0 then
...
when UF_SOURCE='leadssu' then 
                           case when ДеньЗаявки between '20220301' and '20530125' and isInstallment=0 then
											  ...
											  when ДеньЗайма between '20220301' and '20530125' and isInstallment=1 and  ЗаявкаAPI_или_API2=1 then
...
when UF_SOURCE in ('bankiru', 'bankiru_25', 'bankiru-ref') then 
											case 
											  ...
											  when ДеньЗаявки > '20230301' and ЗаявкаAPI_или_API2=0 and isInstallment=0
																						then case 
													...
													when    ДеньЗаявки > '20230301'  and ЛидAPI_или_API2=1 and Лид_Дубль=0
									...
									when ДеньЗаявки between '20230215' and '20230228' and ЛидAPI_или_API2=1 and Лид_Дубль=0
...
when UF_SOURCE in ('bankiru-installment', 'bankiru-installment-ref') then 
											case 
		                                      ...
		                                      when ДеньЗайма between '20230208' and '21240118' and isInstallment=1 and  ЗаявкаAPI_или_API2=0 then
															                                       '{"cost":"'+format(2400 ,'0.00')+'", "for":"'+'займ'+'", "month":"'+МесяцЗаймаТекст+'", "since":"'+'20200401'+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+'по api или api2'+       '"}' 
											 when ДеньЗайма  between '20230208' and '21240118'  and isInstallment=0   then
															                                       '{"cost":"'+format(СуммаЗайма*0.07 ,'0.00')+'", "for":"'+'займ'+'", "month":"'+МесяцЗаймаТекст+'", "since":"'+'20200401'+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+'по api или api2'+       '"}' 
				
		                                      when ДеньЗайма between '20230118' and '21230207' and isInstallment=1 and  ЗаявкаAPI_или_API2=0 then
															                                       '{"cost":"'+format(5000 ,'0.00')+'", "for":"'+'займ'+'", "month":"'+МесяцЗаймаТекст+'", "since":"'+'20200401'+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+'по api или api2'+       '"}' 
											 when ДеньЗайма  between '20230118' and '21230207'  and isInstallment=0   then
															                                       '{"cost":"'+format(СуммаЗайма*0.07 ,'0.00')+'", "for":"'+'займ'+'", "month":"'+МесяцЗаймаТекст+'", "since":"'+'20200401'+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+'по api или api2'+       '"}' 
...
when UF_SOURCE in ('avtolombard24ru', 'avtolombardsru', 'alfalombardru', 'alfalombardru', 'andrey', 'centerzalogru', 'avtolombardzalogru' )
                                                then 
													case 
															when ДеньЗайма >= '20230101' and isInstallment=0  then '{"cost":"'+format( СуммаЗайма*0.05 ,'0.00')+'", "for":"'+'займ'+'", "month":"'+месяцзайматекст+'", "since":"'+'20200710'+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+''+'"}' 
...
when UF_SOURCE='autolombardzalogru_avtolombardzajmru'               then 
																			case 
																			     ...
																			     when ДеньЗайма >= '20220301' and isInstallment=0 then 
																														case  when Регион in ('Москва', 'Санкт-Петербург', 'Московская область') then '{"cost":"'+format( СуммаЗайма*0.05 ,'0.00')+'", "for":"'+'займ'+'", "month":"'+месяцзайматекст+'", "since":"'+''+'", "till":"'+''+'", "condition":"'+''+'", "extra":"'+''+'"}'  
...
when UF_SOURCE='zalogcars'               then 
													case when ДеньЗайма >='20230203'  and isInstallment=0
													
													then 
													
															'{"cost":"'+format( СуммаЗайма*0.08 ,'0.00')+'", "for":"'+'займ'+'", "month":"'+месяцзайматекст+'", "since":"'+''+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+'5%'+'"}'  
...
--																								                               else '{"cost":"'+format( 700,'0.00')+'", "for":"'+'заявку'+'", "month":"'+МесяцЗаявкиТекст+'", "since":"'+'20210319'+'", "till":"'+'now'+'", "condition":"'+'Условия действуют с 19.03.2021 г.: по API - 300 руб. за Заявку по Реферальной ссылке - 700 руб. за Заявку'+'", "extra":"'+'ЗаявкаAPI_или_API2=0'+'"}'   
													...
													when ДеньЗаявки  between '20220301' and '20220331' and isInstallment=0 then 
...
--																								                               else '{"cost":"'+format( 700,'0.00')+'", "for":"'+'заявку'+'", "month":"'+МесяцЗаявкиТекст+'", "since":"'+'20210319'+'", "till":"'+'now'+'", "condition":"'+'Условия действуют с 19.03.2021 г.: по API - 300 руб. за Заявку по Реферальной ссылке - 700 руб. за Заявку'+'", "extra":"'+'ЗаявкаAPI_или_API2=0'+'"}'   
													...
													when ДеньЗаявки  between '20221001'  and '20221031'  and isInstallment=0 then 
																								...
																								case when ЗаявкаAPI_или_API2=0 then '{"cost":"'+format( 1200*isnull([Множитель займов click2 20221001].Метрика, 1),'0.00')+'", "for":"'+'заявку'+'", "month":"'+МесяцЗаявкиТекст+'", "since":"'+''+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+''+'"}'   
--																								                               else '{"cost":"'+format( 700,'0.00')+'", "for":"'+'заявку'+'", "month":"'+МесяцЗаявкиТекст+'", "since":"'+'20210319'+'", "till":"'+'now'+'", "condition":"'+'Условия действуют с 19.03.2021 г.: по API - 300 руб. за Заявку по Реферальной ссылке - 700 руб. за Заявку'+'", "extra":"'+'ЗаявкаAPI_или_API2=0'+'"}'   
																															   end
													...
													when ДеньЗаявки  between '20220801'  and '20220930'  and isInstallment=0 then 
...
when UF_SOURCE='okb-installment-ref'               then 
													case when ДеньЗайма >='20220301' and isInstallment=1 and ЗаявкаAPI_или_API2=0 then 
																								'{"cost":"'+format(3000,'0.00')+'", "for":"'+'займ'+'", "month":"'+МесяцЗаймаТекст+'", "since":"'+'20210319'+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+''+'"}'   
...
when UF_SOURCE='sravniru-installment-ref'               then 
													case 
													
													when ДеньЗайма >='20230125' and isInstallment=1 and ЗаявкаAPI_или_API2=0 then 
																								'{"cost":"'+format(2000,'0.00')+'", "for":"'+'займ'+'", "month":"'+МесяцЗаймаТекст+'", "since":"'+'20210319'+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+''+'"}'   
...
when UF_SOURCE='bistrodengi-pts'               then 
													case when ДеньЗайма >='20220701' and isInstallment=0 then 
...
when UF_SOURCE in ('zapravlyaem-dengami' )
                                                      then 
													case 
			  when ДеньЗайма>='20221201' and isInstallment=1 and  ЗаявкаAPI_или_API2=1 then
			                    '{"cost":"'+format(2500 ,'0.00')+'", "for":"'+'займ'+'", "month":"'+МесяцЗаймаТекст+'", "since":"'+'20200401'+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+'по api или api2'+       '"}' 
			 when ДеньЗайма>='20221201' and isInstallment=0   then
			                     '{"cost":"'+format(СуммаЗайма*0.08 ,'0.00')+'", "for":"'+'займ'+'", "month":"'+МесяцЗаймаТекст+'", "since":"'+'20200401'+'", "till":"'+'now'+'", "condition":"'+''+'", "extra":"'+'по api или api2'+       '"}' 
