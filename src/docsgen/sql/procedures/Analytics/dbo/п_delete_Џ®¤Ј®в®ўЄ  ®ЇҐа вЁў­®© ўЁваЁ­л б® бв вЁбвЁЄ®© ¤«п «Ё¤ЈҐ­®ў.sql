...
CREATE   proc [dbo].[Подготовка оперативной витрины со статистикой для лидгенов]
...
-- select * from #leadgen
 ...
 select uf_source, ДатаЛидаЛСРМ, sum(id) cnt into #leads from    [Feodor].[dbo].[dm_leads_history_cube_by_ДатаЛидаЛСРМ] a
