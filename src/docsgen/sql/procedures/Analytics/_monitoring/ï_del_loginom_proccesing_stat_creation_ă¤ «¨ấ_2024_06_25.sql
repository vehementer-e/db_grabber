...
create     proc _monitoring.[loginom_proccesing_stat_creation]
as
begin
...
delete a from   _monitoring.loginom_proccesing_stat a join #t1 b on a.dt=b.dt
insert into  _monitoring.loginom_proccesing_stat
select * from  #t1
