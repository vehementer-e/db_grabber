...
CREATE procedure [dbo].[Fraud_doubles_uat] @ClientRequestId uniqueidentifier
as
begin
	...
	create table #resultTable ( searchRule                    nchar(100)
	,                           ClientRequestId               uniqueidentifier
	,                           OriginalField                 nchar(150)
	,                           DuplicateField                nchar(150)
