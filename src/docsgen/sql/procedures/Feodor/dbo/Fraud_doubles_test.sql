...
--select * from dbo.dm_FeodorRequests_test where ClientRequestNumber = '1604192160001'
...
CREATE   PROC [dbo].[Fraud_doubles_test] @ClientRequestId  uniqueidentifier
	,@isDebug int = 0
as
begin
...
--	set @ClientRequestId =  '4CC0F964-CFE9-4E15-BCA2-A00221015C30'
	...
	*/
	...
	,	   t.TableSource
	--from [dbo].[v_dm_FeodorRequests_ClientContactPersons] t
	FROM dbo.dm_FeodorRequests_test AS t
	where t.ClientRequestId != @ClientRequestId
	...
	delete  M FROM #resultTable AS M
