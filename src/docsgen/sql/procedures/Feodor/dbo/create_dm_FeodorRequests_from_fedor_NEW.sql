...
create   PROC dbo.create_dm_FeodorRequests_from_fedor_NEW
	@isReloadAll bit= 0
...
begin
	...
	join stg.[_fedor].dictionary_ClientRequestStatus [ClientRequestStatus] on cr.IdStatus = [ClientRequestStatus].[Id]
			...
			*
			...
			begin
				begin tran ClientContactPerson
					...
					select * from #ClientContactPerson
				commit tran
			end
	end
	...
	begin
		...
		begin
			begin tran ClientPhoneType
				...
				select * from #dm_FeodorRequests_ClientPhone
			commit tran
		end
	end
	...
	begin
		...
		begin tran ClientAddress
			...
			select * from #dm_FeodorRequests_ClientAddress
		commit tran
		end
